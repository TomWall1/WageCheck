...
const AWARD_NAMES: Record<string, string> = {
  ...
  MA000006: 'Black Coal Mining Award',
  MA000007: 'Cement & Quarrying Award',
  MA000008: 'Wool Storage Award',
  MA000011: 'Oil Refining Award',
  MA000014: 'Mining Industry Award',
  MA000015: 'Ports & Harbours Award',
  MA000024: 'Cotton Ginning Award',
  MA000035: 'Pastoral Award',
  MA000039: 'Seafood Processing Award',
  MA000040: 'Sugar Industry Award',
  MA000044: 'Timber Industry Award',
  MA000045: 'Premixed Concrete Award',
  MA000046: 'Textile & Clothing Award',
  MA000001: 'Aboriginal Health Services Award',
  MA000017: 'Corrections & Detention Award',
  MA000031: 'Mannequins & Models Award',
  MA000037: 'Salt Industry Award',
  MA000047: 'Asphalt Industry Award',
  MA000048: 'Cemetery Industry Award',
  MA000050: 'Concrete Products Award',
  MA000051: 'Coal Export Terminals Award',
  MA000054: 'Electrical Power Award',
  MA000060: 'Marine Tourism Award',
  MA000061: 'Airline Ground Staff Award',
  MA000062: 'Airport Employees Award',
  MA000064: 'Pest Control Award',
  MA000066: 'Horse & Greyhound Training Award',
  MA000067: 'Hydrocarbons (Upstream) Award',
  MA000070: 'Silviculture Award',
  MA000075: 'Rail Industry Award',
  MA000078: 'Stevedoring Award',
};
