    ...
    <div>
      ...
      <section style={sectionStyle}>
        <div style={exampleBoxStyle}>
          ...
          <p style={{ ...pStyle, marginBottom: '4px' }}><strong>What they were paid:</strong> {formatCurrency(l2?.casualRate ?? 0)}/hr flat</p>
          <p style={{ ...pStyle, marginBottom: '4px' }}><strong>What should have happened:</strong> Saturday casual rate ({formatCurrency(l2?.saturdayCasual ?? 0)}/hr) + evening loading after 7pm (+{formatCurrency(eveningLoading)}/hr)</p>
      ...
      <section style={sectionStyle}>
        ...
        <div style={{ overflowX: 'auto', marginBottom: '1rem' }}>
          <table style={tableStyle}>
            ...
            <tbody>
              <tr><td style={tdStyle}>Level 2</td><td style={tdStyle}>{formatCurrency(l2?.casualRate ?? 0)}/hr</td><td style={tdStyle}>{formatCurrency(l2?.saturdayCasual ?? 0)}/hr</td><td style={tdStyle}>{formatCurrency(l2?.sundayCasual ?? 0)}/hr</td><td style={tdStyle}>{formatCurrency(l2?.publicHolidayCasual ?? 0)}/hr</td></tr>
              <tr><td style={tdStyle}>Level 3</td><td style={tdStyle}>{formatCurrency(l3?.casualRate ?? 0)}/hr</td><td style={tdStyle}>{formatCurrency(l3?.saturdayCasual ?? 0)}/hr</td><td style={tdStyle}>{formatCurrency(l3?.sundayCasual ?? 0)}/hr</td><td style={tdStyle}>{formatCurrency(l3?.publicHolidayCasual ?? 0)}/hr</td></tr>
            </tbody>
          </table>
        </div>
        <p style={smallStyle}>
      ...
      <section style={sectionStyle}>
        <div style={warningBoxStyle}>
          ...
          <p style={pStyle}>
            Sunday casual should be {formatCurrency(l2?.sundayCasual ?? 0)}/hr at Level 2. A flat $31/hr or $32/hr on a Sunday is significantly underpaid.
          </p>
