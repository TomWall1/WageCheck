...
export const GUIDES: GuideInfo[] = [
  { slug: 'what-is-a-modern-award', title: 'What Is a Modern Award?', description: 'Plain-English explanation of what modern awards are in Australia, who they cover, how to find which one applies to you, and what pay conditions they set.', keywords: ['modern award australia', 'what is a modern award', 'fair work awards'], brief: 'What modern awards are, who they cover, how to find yours. Foundation page for the entire site.', tags: ['Awards', 'Getting Started'] },
  ...
  { slug: 'overtime-pay-australia', title: 'Overtime Pay in Australia', description: 'How overtime pay works in Australia: time-and-a-half, double-time, daily vs weekly triggers, TOIL arrangements, and the most common employer errors to watch.', keywords: ['overtime pay australia', 'overtime rates', 'time and a half'], brief: 'Time-and-a-half, double-time, daily vs weekly triggers, TOIL, common employer errors.', tags: ['Pay Rights'] },
  ...
  { slug: 'how-to-report-underpayment', title: 'How to Report Underpayment', description: 'Step-by-step guide to reporting underpayment in Australia: how to raise it with your employer, lodge a Fair Work Ombudsman complaint, and explore legal options.', keywords: ['report underpayment australia', 'fair work complaint', 'wage theft report'], brief: 'Step-by-step: raise with employer, FWO complaint, legal options, what to document.', tags: ['Pay Rights'] },
  { slug: 'minimum-wage-australia-2025', title: 'Minimum Wage Australia 2025', description: 'Current Australian minimum wage rate, the annual Fair Work Commission review process, and the key difference between the national minimum wage and award rates.', keywords: ['minimum wage australia 2025', 'national minimum wage', 'minimum hourly rate'], brief: 'National Minimum Wage vs award minimums. Annual FWC review. Current rate.', tags: ['Pay Rights', 'Getting Started'] },
  ...
  { slug: 'wage-theft-australia', title: 'Wage Theft in Australia', description: 'Fair Work Ombudsman recovery statistics, the industries most affected by wage theft, and the new criminal wage theft provisions now in effect across Australia.', keywords: ['wage theft australia', 'underpayment statistics', 'criminal wage theft'], brief: 'FWO recovery statistics, most affected industries, new criminal wage theft provisions.', tags: ['Pay Rights'] },
  { slug: 'flat-rate-vs-award', title: 'Flat Rate vs Award Pay', description: 'Can an employer pay a flat rate instead of award rates in Australia? When a flat rate is legal, what it must include, and how to check yours is compliant.', keywords: ['flat rate vs award', 'flat rate pay australia', 'annualised salary award'], brief: 'Can an employer pay a flat rate instead of award rates? When is it legal, what must it include?', tags: ['Pay Rights', 'Awards'] },
  { slug: 'how-to-read-your-payslip', title: 'How to Read Your Payslip', description: 'Payslip line-by-line guide for Australian workers: ordinary hours, penalty rate lines, superannuation, tax, deductions, and red flags that signal underpayment.', keywords: ['how to read payslip australia', 'payslip explained', 'payslip requirements'], brief: 'Payslip line-by-line: ordinary hours, penalty lines, super, tax, deductions. Red flags to watch for.', tags: ['Getting Started'] },
  ...
  { slug: 'superannuation-casual-workers', title: 'Superannuation for Casual Workers', description: 'When super must be paid for casual workers in Australia, how to check your super is being paid correctly, and how to report unpaid superannuation to the ATO.', keywords: ['superannuation casual workers', 'super casual employees', 'unpaid super'], brief: '$450 threshold abolition (2022). When super must be paid. How to check and report unpaid super.', tags: ['Casual', 'Pay Rights'] },
