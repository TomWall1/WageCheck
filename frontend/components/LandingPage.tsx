...
const AWARDS = [
  ...
  {
    code: 'MA000006' as AwardCode, name: 'Black Coal Mining Industry Award 2020',
    shortName: 'Black Coal Mining Award',
    description: 'Covers employees in the black coal mining industry including production and engineering mineworkers.',
    examples: 'Mineworkers, machine operators, shot firers, tradespeople, leading hands, underground operators',
    badge: 'MA000006',
  },
  {
    code: 'MA000007' as AwardCode, name: 'Cement, Lime and Quarrying Award 2020',
    shortName: 'Cement & Quarrying Award',
    description: 'Covers employees in cement manufacturing, lime production, and quarrying operations.',
    examples: 'Quarry workers, crusher operators, kiln operators, cement process workers, laboratory technicians',
    badge: 'MA000007',
  },
  {
    code: 'MA000008' as AwardCode, name: 'Wool Storage, Sampling and Testing Award 2020',
    shortName: 'Wool Storage Award',
    description: 'Covers employees in wool storage, sampling, testing, and related operations in the wool industry.',
    examples: 'Wool handlers, wool samplers, wool testers, storeworkers, quality controllers, classing assistants',
    badge: 'MA000008',
  },
  {
    code: 'MA000011' as AwardCode, name: 'Oil Refining and Manufacturing Award 2020',
    shortName: 'Oil Refining Award',
    description: 'Covers employees in oil refining, petroleum manufacturing, and associated processing operations.',
    examples: 'Process workers, refinery operators, plant operators, laboratory technicians, leading hands',
    badge: 'MA000011',
  },
  {
    code: 'MA000014' as AwardCode, name: 'Mining Industry Award 2020',
    shortName: 'Mining Industry Award',
    description: 'Covers employees in the metalliferous mining and quarrying industry including surface and underground operations.',
    examples: 'Mineworkers, drill operators, bogger operators, tradespeople, shot firers, mine supervisors',
    badge: 'MA000014',
  },
  {
    code: 'MA000015' as AwardCode, name: 'Ports, Harbours and Enclosed Water Vessels Award 2020',
    shortName: 'Ports & Harbours Award',
    description: 'Covers employees working in ports, harbours, and on enclosed water vessels including stevedoring and marina operations.',
    examples: 'Stevedores, wharf workers, crane operators, forklift drivers, marina attendants, vessel crew',
    badge: 'MA000015',
  },
  {
    code: 'MA000024' as AwardCode, name: 'Cotton Ginning Award 2020',
    shortName: 'Cotton Ginning Award',
    description: 'Covers employees in cotton ginning operations including gin workers, press operators, and maintenance staff.',
    examples: 'Gin workers, press operators, module feeders, cotton classers, maintenance workers, gin supervisors',
    badge: 'MA000024',
  },
  {
    code: 'MA000035' as AwardCode, name: 'Pastoral Award 2020',
    shortName: 'Pastoral Award',
    description: 'Covers employees in the pastoral industry including farming, grazing, and stock handling operations.',
    examples: 'Station hands, stockpersons, farm workers, shearers, tractor operators, overseers, jackaroos/jillaroos',
    badge: 'MA000035',
  },
  {
    code: 'MA000039' as AwardCode, name: 'Seafood Processing Award 2020',
    shortName: 'Seafood Processing Award',
    description: 'Covers employees in seafood processing including fish filleting, shellfish processing, and cold storage operations.',
    examples: 'Fish filleters, seafood processors, shellfish shuckers, packers, cold store workers, quality controllers',
    badge: 'MA000039',
  },
  {
    code: 'MA000040' as AwardCode, name: 'Sugar Industry Award 2020',
    shortName: 'Sugar Industry Award',
    description: 'Covers employees in the sugar industry including sugar cane harvesting, milling, and refining operations.',
    examples: 'Cane harvesters, mill workers, refinery operators, boiler attendants, sugar process workers, maintenance staff',
    badge: 'MA000040',
  },
  {
    code: 'MA000044' as AwardCode, name: 'Timber Industry Award 2020',
    shortName: 'Timber Industry Award',
    description: 'Covers employees in the timber industry including sawmilling, timber processing, and forestry operations.',
    examples: 'Sawmill workers, timber processors, kiln operators, forestry workers, graders, stackers, leading hands',
    badge: 'MA000044',
  },
  {
    code: 'MA000045' as AwardCode, name: 'Premixed Concrete Award 2020',
    shortName: 'Premixed Concrete Award',
    description: 'Covers employees in the premixed concrete industry including batching, delivery, and pump operations.',
    examples: 'Agitator drivers, boom pump operators, batchers, yardpersons, concrete testers, leading hands',
    badge: 'MA000045',
  },
  {
    code: 'MA000046' as AwardCode, name: 'Textile, Clothing, Footwear and Associated Industries Award 2020',
    shortName: 'Textile & Clothing Award',
    description: 'Covers employees in textile, clothing, and footwear manufacturing including fabric production, garment making, and leather work.',
    examples: 'Machinists, cutters, sewers, pressers, pattern makers, fabric inspectors, footwear makers, leather workers',
    badge: 'MA000046',
  },
  {
    code: 'MA000001' as AwardCode, name: 'Aboriginal Community Controlled Health Services Award 2020',
    shortName: 'Aboriginal Health Services Award',
    description: 'Covers employees in Aboriginal community controlled health services including health workers, clinical support, and program coordinators.',
    examples: 'Aboriginal health workers, clinical support staff, health program coordinators, community health practitioners',
    badge: 'MA000001',
  },
  {
    code: 'MA000017' as AwardCode, name: 'Corrections and Detention (Private Sector) Award 2020',
    shortName: 'Corrections & Detention Award',
    description: 'Covers employees in private sector corrections and immigration detention facilities.',
    examples: 'Correctional officers, detention officers, case managers, custodial supervisors',
    badge: 'MA000017',
  },
  {
    code: 'MA000031' as AwardCode, name: 'Mannequins and Models Award 2020',
    shortName: 'Mannequins & Models Award',
    description: 'Covers mannequins and models engaged in photographic, runway, promotional, and fitting work.',
    examples: 'Photographic models, runway models, fitting models, promotional models',
    badge: 'MA000031',
  },
  {
    code: 'MA000037' as AwardCode, name: 'Salt Industry Award 2020',
    shortName: 'Salt Industry Award',
    description: 'Covers employees in the salt harvesting, processing, and manufacturing industry.',
    examples: 'Salt harvesters, processing plant operators, maintenance workers, salt packers, leading hands',
    badge: 'MA000037',
  },
  {
    code: 'MA000047' as AwardCode, name: 'Asphalt Industry Award 2020',
    shortName: 'Asphalt Industry Award',
    description: 'Covers employees in the asphalt manufacturing and laying industry.',
    examples: 'Asphalt labourers, rakers, roller operators, paver operators, plant operators, foremen',
    badge: 'MA000047',
  },
  {
    code: 'MA000048' as AwardCode, name: 'Cemetery Industry Award 2020',
    shortName: 'Cemetery Industry Award',
    description: 'Covers employees in cemeteries, crematoria, and memorial parks including grounds staff and operations.',
    examples: 'Grounds workers, gravediggers, crematorium operators, memorial masons, cemetery administrators',
    badge: 'MA000048',
  },
  {
    code: 'MA000050' as AwardCode, name: 'Concrete Products Award 2020',
    shortName: 'Concrete Products Award',
    description: 'Covers employees in the manufacture of concrete products including pipes, blocks, pavers, and precast panels.',
    examples: 'Production workers, mould operators, batch plant operators, forklift drivers, quality testers',
    badge: 'MA000050',
  },
  {
    code: 'MA000051' as AwardCode, name: 'Coal Export Terminals Award 2020',
    shortName: 'Coal Export Terminals Award',
    description: 'Covers employees at coal export terminals including loading, stockpile management, and maintenance.',
    examples: 'Terminal hands, conveyor operators, shiploader operators, stacker operators, maintenance fitters',
    badge: 'MA000051',
  },
  {
    code: 'MA000054' as AwardCode, name: 'Electrical Power Industry Award 2020',
    shortName: 'Electrical Power Award',
    description: 'Covers employees in the electrical power generation, transmission, and distribution industry.',
    examples: 'Power station operators, lineworkers, electricians, fitters, network controllers, shift supervisors',
    badge: 'MA000054',
  },
  {
    code: 'MA000060' as AwardCode, name: 'Marine Tourism and Charter Vessels Award 2020',
    shortName: 'Marine Tourism Award',
    description: 'Covers employees on charter vessels and marine tourism operations including whale watching, diving, and reef tours.',
    examples: 'Deckhands, dive instructors, vessel masters, hospitality crew, marine tour guides',
    badge: 'MA000060',
  },
  {
    code: 'MA000061' as AwardCode, name: 'Airline Operations—Ground Staff Award 2020',
    shortName: 'Airline Ground Staff Award',
    description: 'Covers airline ground handling staff including ramp operations, baggage handling, and check-in.',
    examples: 'Ramp handlers, baggage handlers, check-in agents, load controllers, ground equipment operators',
    badge: 'MA000061',
  },
  {
    code: 'MA000062' as AwardCode, name: 'Airport Employees Award 2020',
    shortName: 'Airport Employees Award',
    description: 'Covers employees of airport operators and service providers at airports.',
    examples: 'Terminal assistants, airside officers, equipment operators, airport maintenance staff, security screeners',
    badge: 'MA000062',
  },
  {
    code: 'MA000064' as AwardCode, name: 'Pest Control Industry Award 2020',
    shortName: 'Pest Control Award',
    description: 'Covers employees in the pest control and fumigation industry.',
    examples: 'Pest control technicians, fumigators, termite inspectors, pest control assistants, operations managers',
    badge: 'MA000064',
  },
  {
    code: 'MA000066' as AwardCode, name: 'Horse and Greyhound Training Award 2020',
    shortName: 'Horse & Greyhound Training Award',
    description: 'Covers employees in the horse and greyhound racing training industry.',
    examples: 'Stablehands, kennel attendants, trackwork riders, forepersons, trainer assistants',
    badge: 'MA000066',
  },
  {
    code: 'MA000067' as AwardCode, name: 'Hydrocarbons Industry (Upstream) Award 2020',
    shortName: 'Hydrocarbons (Upstream) Award',
    description: 'Covers employees in upstream oil and gas exploration and production operations.',
    examples: 'Roustabouts, drillers, production operators, derrickhands, tool pushers, rig supervisors',
    badge: 'MA000067',
  },
  {
    code: 'MA000070' as AwardCode, name: 'Silviculture Award 2020',
    shortName: 'Silviculture Award',
    description: 'Covers employees in silviculture and forestry operations including tree planting, pruning, and harvesting preparation.',
    examples: 'Tree planters, pruners, brush cutter operators, chainsaw operators, forestry forepersons',
    badge: 'MA000070',
  },
  {
    code: 'MA000075' as AwardCode, name: 'Rail Industry Award 2020',
    shortName: 'Rail Industry Award',
    description: 'Covers employees in the rail transport industry including train operations, signalling, and maintenance.',
    examples: 'Train drivers, shunters, signallers, track workers, rolling stock fitters, depot supervisors',
    badge: 'MA000075',
  },
  {
    code: 'MA000078' as AwardCode, name: 'Stevedoring Industry Award 2020',
    shortName: 'Stevedoring Award',
    description: 'Covers stevedoring employees involved in loading and unloading ships at ports.',
    examples: 'Wharf labourers, crane operators, straddle carrier drivers, foremen, ship planners',
    badge: 'MA000078',
  },
];
