/**
 * Seed script — Premixed Concrete Award 2020 [MA000057]
 * Pay rates effective 1 July 2025 (following 2025 Annual Wage Review)
 * Rates sourced from FWC MAPD API.
 *
 * Run after migrate.js: node scripts/seed_ma000057.js
 */
require('dotenv').config();
const pool = require('../src/db/pool');

const AWARD_CODE = 'MA000057';
...
async function seed() {
  ...
  try {
    ...
    `, [
      ...
      EFFECTIVE_DATE,
      'https://www.fairwork.gov.au/employment-conditions/awards/awards-summary/ma000057-summary',
    ]);
    ...
    const classifications = [
      {
        ...
        title: 'Level 1',
        description: 'Entry-level premixed concrete employee performing basic labouring, cleaning, and material handling tasks under direct supervision.',
        duties: ['Performing basic labouring and yard duties', 'Cleaning vehicles, plant, and work areas', 'Assisting with loading and unloading raw materials', 'Following safety instructions and wearing required PPE'],
        indicative_tasks: [],
        sort_order: 10,
      },
      {
        ...
        title: 'Level 2',
        description: 'Premixed concrete employee with developing skills performing production tasks including batching, truck operation, and basic maintenance.',
        duties: ['Operating concrete agitator trucks for deliveries', 'Assisting with batching and mixing concrete to specifications', 'Performing basic maintenance on plant and equipment', 'Loading additives and materials into batch plants'],
        indicative_tasks: [],
        sort_order: 30,
      },
      {
        ...
        title: 'Level 3',
        description: 'Experienced premixed concrete employee performing skilled tasks including concrete pumping, batch plant operation, and quality testing.',
        duties: ['Operating batch plants and concrete pumps', 'Performing concrete quality testing and slump tests', 'Driving and operating heavy concrete delivery vehicles', 'Training and guiding lower-level employees on procedures'],
        indicative_tasks: [],
        sort_order: 50,
      },
      {
        ...
        title: 'Level 4',
        description: 'Senior premixed concrete employee or tradesperson performing advanced production, maintenance, or supervisory duties.',
        duties: ['Performing trade-level maintenance on batch plants and equipment', 'Supervising production teams and delivery schedules', 'Troubleshooting production and equipment issues', 'Ensuring compliance with quality and safety standards'],
        indicative_tasks: [],
        sort_order: 70,
      },
      {
        ...
        title: 'Level 5',
        description: 'Advanced or specialist premixed concrete employee performing highly skilled technical, production management, or supervisory duties.',
        duties: ['Managing batch plant operations and production scheduling', 'Developing mix designs and quality assurance procedures', 'Overseeing maintenance programs for plant and fleet', 'Leading teams and coordinating logistics across multiple sites'],
        indicative_tasks: [],
        sort_order: 90,
      },
    ];
    ...
    const penaltyRates = [
      {
        ...
        description: 'Day work — Full-time ×1',
      },
      {
      ...
      },
      {
        ...
        time_band_start: null, time_band_end: null, time_band_label: null,
        multiplier: 1, addition_per_hour: null,
        description: 'Day work — Part-time ×1',
      },
      {
    ...
    const allowances = [
      ...
      },
      {
        ...
        name: 'Travel, board and lodging—board and lodging—per day',
        description: 'Travel, board and lodging—board and lodging—per day',
        trigger_condition: 'As per award conditions',
        amount: 106.38, amount_type: 'fixed', per_unit: 'per_shift',
      },
      {
        allowance_type: 'travel',
        name: 'Travel, board and lodging—board and lodging—per week',
        description: 'Travel, board and lodging—board and lodging—per week',
        trigger_condition: 'As per award conditions',
        amount: 755.97, amount_type: 'fixed', per_unit: 'per_shift',
      },
      {
        allowance_type: 'meal',
      ...
      },
      {
        ...
        trigger_condition: 'As per award conditions',
        amount: 19.27, amount_type: 'weekly', per_unit: 'per_week',
      },
    ];
