/**
 * Seed script — Marine Tourism and Charter Vessels Award 2020 [MA000060]
 * Pay rates effective 1 July 2025
 * Source: FWC MAPD API + FWO pay guide MA000040
 *
 * One stream:
 *   marine_tourism — Levels 1–5 (5 classifications)
 *
...
async function seed() {
  ...
  try {
    ...
    `, [
      ...
      EFFECTIVE_DATE,
      'https://awards.fairwork.gov.au/MA000060.html',
    ]);

    // ── Classifications ────────────────────────────────────────────────────────
    const classifications = [
      { level: 1, stream: 'marine_tourism', fwc_id: null, title: 'Marine Tourism Level 1', description: 'Entry-level deckhand or hospitality crew on charter vessels.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Marine Tourism Level 1'], sort_order: 10 },
      { level: 2, stream: 'marine_tourism', fwc_id: null, title: 'Marine Tourism Level 2', description: 'Experienced crew member performing a range of vessel duties.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Marine Tourism Level 2'], sort_order: 20 },
      { level: 3, stream: 'marine_tourism', fwc_id: null, title: 'Marine Tourism Level 3', description: 'Qualified crew with coxswain or relevant marine ticket.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Marine Tourism Level 3'], sort_order: 30 },
      { level: 4, stream: 'marine_tourism', fwc_id: null, title: 'Marine Tourism Level 4', description: 'Senior crew or master of a small charter vessel.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Marine Tourism Level 4'], sort_order: 40 },
      { level: 5, stream: 'marine_tourism', fwc_id: null, title: 'Marine Tourism Level 5', description: 'Master or chief engineer of larger charter operations.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Marine Tourism Level 5'], sort_order: 50 },
    ];
    ...
    //   Q1: marine_tourism_level — level 1 through 5
    const questions = [
      {
        question_key: 'marine_tourism_level',
        question_text: 'What is your marine tourism classification level?',
        help_text: 'Your level depends on your role and qualifications. Level 1 is entry-level deckhand work. Higher levels involve ticketed master and engineer roles.',
    ...
    const answers = [
      { question_key: 'marine_tourism_level', answer_key: 'l1', answer_text: 'Level 1 — Entry-level (deckhand, hospitality crew)', sort_order: 1 },
      { question_key: 'marine_tourism_level', answer_key: 'l2', answer_text: 'Level 2 — Experienced (senior deckhand, dive crew)', sort_order: 2 },
      { question_key: 'marine_tourism_level', answer_key: 'l3', answer_text: 'Level 3 — Qualified (coxswain, ticketed crew)', sort_order: 3 },
      { question_key: 'marine_tourism_level', answer_key: 'l4', answer_text: 'Level 4 — Senior (small vessel master)', sort_order: 4 },
      { question_key: 'marine_tourism_level', answer_key: 'l5', answer_text: 'Level 5 — Master/chief engineer (large vessel operations)', sort_order: 5 },
    ];
