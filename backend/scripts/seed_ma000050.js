/**
 * Seed script — Concrete Products Award 2020 [MA000050]
 * Pay rates effective 1 July 2025
 * Source: FWC MAPD API + FWO pay guide MA000040
 *
 * One stream:
 *   concrete_products — Levels 1–5 (5 classifications)
 *
...
async function seed() {
  ...
  try {
    ...
    `, [
      ...
      EFFECTIVE_DATE,
      'https://awards.fairwork.gov.au/MA000050.html',
    ]);

    // ── Classifications ────────────────────────────────────────────────────────
    const classifications = [
      { level: 1, stream: 'concrete_products', fwc_id: null, title: 'Concrete Products Level 1', description: 'Entry-level production worker performing basic concrete manufacturing tasks.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Concrete Products Level 1'], sort_order: 10 },
      { level: 2, stream: 'concrete_products', fwc_id: null, title: 'Concrete Products Level 2', description: 'Experienced worker operating basic moulds and machinery.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Concrete Products Level 2'], sort_order: 20 },
      { level: 3, stream: 'concrete_products', fwc_id: null, title: 'Concrete Products Level 3', description: 'Skilled operator managing concrete production processes independently.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Concrete Products Level 3'], sort_order: 30 },
      { level: 4, stream: 'concrete_products', fwc_id: null, title: 'Concrete Products Level 4', description: 'Tradesperson or advanced operator with qualifications.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Concrete Products Level 4'], sort_order: 40 },
      { level: 5, stream: 'concrete_products', fwc_id: null, title: 'Concrete Products Level 5', description: 'Leading hand or supervisor coordinating production operations.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Concrete Products Level 5'], sort_order: 50 },
    ];
    ...
    //   Q1: concrete_products_level — level 1 through 5
    const questions = [
      {
        question_key: 'concrete_products_level',
        question_text: 'What is your concrete products classification level?',
        help_text: 'Your level depends on your experience and duties. Level 1 is entry-level production work. Higher levels involve skilled operation and supervision.',
    ...
    const answers = [
      { question_key: 'concrete_products_level', answer_key: 'l1', answer_text: 'Level 1 — Entry-level (production worker, labourer)', sort_order: 1 },
      { question_key: 'concrete_products_level', answer_key: 'l2', answer_text: 'Level 2 — Experienced (mould operator, batch worker)', sort_order: 2 },
      { question_key: 'concrete_products_level', answer_key: 'l3', answer_text: 'Level 3 — Skilled (plant operator, quality tester)', sort_order: 3 },
      { question_key: 'concrete_products_level', answer_key: 'l4', answer_text: 'Level 4 — Tradesperson (fitter, advanced operator)', sort_order: 4 },
      { question_key: 'concrete_products_level', answer_key: 'l5', answer_text: 'Level 5 — Supervisor (leading hand, production supervisor)', sort_order: 5 },
    ];
