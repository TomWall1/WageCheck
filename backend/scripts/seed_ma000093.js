    ...
    const classifications = [
      {
        ...
        title: 'Crew Level 1',
        description: 'Entry-level crew member on non-overnight charter or tourism vessels performing basic deck, passenger service, and safety duties.',
        duties: ['Assisting passengers with boarding and disembarking', 'Performing basic deck duties including line handling', 'Maintaining cleanliness of vessel areas', 'Assisting with safety briefings and equipment checks'],
        indicative_tasks: [],
        sort_order: 10,
      },
      {
        ...
        title: 'Crew Level 1',
        description: 'Entry-level crew member on overnight charter vessels performing basic deck, housekeeping, and passenger service duties.',
        duties: ['Performing cabin preparation and housekeeping duties', 'Assisting with meal service and galley operations', 'Maintaining cleanliness of cabins and common areas', 'Assisting with passenger safety and comfort'],
        indicative_tasks: [],
        sort_order: 20,
      },
      {
        ...
        title: 'Crew Level 2',
        description: 'Experienced crew member on non-overnight charter vessels performing a range of deck operations and passenger service duties.',
        duties: ['Operating vessel equipment and navigation aids', 'Providing comprehensive passenger service and commentary', 'Performing deck maintenance and safety equipment checks', 'Assisting the master or coxswain with vessel operations'],
        indicative_tasks: [],
        sort_order: 30,
      },
      {
        ...
        title: 'Crew Level 2',
        description: 'Experienced crew member on overnight charter vessels performing skilled duties in deck operations, hospitality, or diving support.',
        duties: ['Operating vessel equipment and assisting with navigation', 'Preparing and serving meals and beverages on board', 'Managing passenger activities and excursions', 'Performing vessel maintenance and safety duties'],
        indicative_tasks: [],
        sort_order: 40,
      },
      {
        ...
        title: 'Coxswain',
        description: 'Qualified coxswain commanding small non-overnight charter or tourism vessels with responsibility for vessel safety and navigation.',
        duties: ['Commanding vessel operations and navigation', 'Ensuring compliance with maritime safety regulations', 'Managing crew and coordinating passenger services', 'Conducting vessel safety checks and emergency drills'],
        indicative_tasks: [],
        sort_order: 50,
      },
      {
        ...
        title: 'Crew Level 3',
        description: 'Senior crew member on overnight charter vessels performing advanced operational duties and coordinating service delivery.',
        duties: ['Coordinating daily operations and service schedules', 'Supervising junior crew members and delegating tasks', 'Managing provisions, stores, and inventory', 'Performing advanced deck and safety duties'],
        indicative_tasks: [],
        sort_order: 60,
      },
      {
        ...
        description: 'Qualified divemaster or dive instructor on overnight charter vessels leading recreational dive operations and providing instruction.',
        duties: ['Leading and supervising recreational dive activities', 'Conducting dive briefings and safety assessments', 'Teaching diving skills and certifying students', 'Maintaining dive equipment and managing dive operations'],
        indicative_tasks: [],
        sort_order: 70,
      },
      {
        ...
        title: 'Coxswain',
        description: 'Qualified coxswain commanding overnight charter vessels with responsibility for vessel operations, safety, and crew management.',
        duties: ['Commanding overnight vessel operations and navigation', 'Managing crew rosters, duties, and performance', 'Ensuring vessel compliance with maritime regulations', 'Overseeing all aspects of passenger safety and service'],
        indicative_tasks: [],
        sort_order: 80,
      },
      {
        ...
        description: 'Marine engineer with MED III certification responsible for engine room operations and mechanical maintenance on non-overnight charter vessels.',
        duties: ['Operating and maintaining vessel propulsion systems', 'Performing routine servicing and repairs on machinery', 'Monitoring engine performance and fuel systems', 'Maintaining engineering logs and defect reports'],
        indicative_tasks: [],
        sort_order: 90,
      },
      {
        level: 4, stream: 'non_overnight_charter_employees',
        title: 'Master V',
        description: 'Qualified Master Class V commanding non-overnight charter or tourism vessels within enclosed or near-coastal waters.',
        duties: ['Commanding vessel operations and navigation', 'Ensuring safety of all passengers, crew, and the vessel', 'Managing crew and coordinating vessel schedules', 'Communicating with port authorities and marine traffic'],
        indicative_tasks: [],
        sort_order: 100,
      },
      {
        ...
        description: 'Senior marine engineer with MED II certification performing advanced engineering duties on larger non-overnight charter vessels.',
        duties: ['Managing engine room operations on larger vessels', 'Performing complex repairs and maintenance on marine systems', 'Supervising engine room staff and maintenance programs', 'Ensuring compliance with marine engineering standards'],
        indicative_tasks: [],
        sort_order: 110,
      },
      {
        level: 5, stream: 'non_overnight_charter_employees',
        title: 'Master IV',
        description: 'Qualified Master Class IV commanding larger non-overnight charter or tourism vessels with extended operational range.',
        duties: ['Commanding larger vessels on extended charter operations', 'Managing complex navigation and passage planning', 'Overseeing all safety management systems', 'Liaising with maritime authorities and charter operators'],
        indicative_tasks: [],
        sort_order: 120,
      },
      {
        ...
        title: 'Master V',
        description: 'Qualified Master Class V commanding overnight charter vessels with responsibility for extended voyages and passenger safety.',
        duties: ['Commanding overnight charter vessel operations', 'Planning and executing multi-day voyages', 'Managing all aspects of vessel safety and compliance', 'Overseeing crew and ensuring high-quality service delivery'],
        indicative_tasks: [],
        sort_order: 130,
      },
      {
        ...
        description: 'Chief marine engineer with MED I certification providing the highest level of engineering expertise on non-overnight charter vessels.',
        duties: ['Providing chief engineering oversight on large vessels', 'Managing complex propulsion and auxiliary systems', 'Leading engineering teams and maintenance programs', 'Ensuring vessel engineering compliance with all regulations'],
        indicative_tasks: [],
        sort_order: 140,
      },
      {
        ...
        title: 'Master IV',
        description: 'Qualified Master Class IV commanding larger overnight charter vessels with broad operational responsibilities.',
        duties: ['Commanding large overnight charter vessels', 'Managing complex voyage planning and execution', 'Overseeing all vessel operations, crew, and passenger safety', 'Maintaining the highest standards of maritime compliance'],
        indicative_tasks: [],
        sort_order: 150,
      },
    ];
