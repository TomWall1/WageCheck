/**
 * Seed script — Textile, Clothing, Footwear and Associated Industries Award 2020 [MA000046]
 * Pay rates effective 1 July 2025
 * Source: FWC MAPD API + FWO pay guide MA000046
 *
 * One stream:
 *   textile — Levels 1–5 (5 classifications)
 *
 ...
 *
 * Allowances:
 *   Meal: $20.96 (OT >2hrs), First aid: $16.78/week, Laundry: $3.55/week
 *
 * Run after migrate.js: node scripts/seed_ma000046.js
 */
require('dotenv').config();
const pool = require('../src/db/pool');

const AWARD_CODE = 'MA000046';
...
async function seed() {
  ...
  try {
    ...
    `, [
      ...
      EFFECTIVE_DATE,
      'https://awards.fairwork.gov.au/MA000046.html',
    ]);

    // ── Classifications ────────────────────────────────────────────────────────
    const classifications = [
      {
        level: 1, stream: 'textile',
        fwc_id: null,
        title: 'Textile Level 1',
        description: 'Entry-level process worker. You perform basic tasks under direct supervision, including simple assembly, packing, and routine production duties.',
        duties: [
          'Performing basic hand or machine operations under direct supervision',
          'Packing, labelling, and sorting finished products',
          'Maintaining a clean and safe work area',
          'Following standard operating procedures for routine production tasks',
        ],
        indicative_tasks: ['Process worker (entry)', 'Packer', 'Sorter'],
        sort_order: 10,
      },
      {
        level: 2, stream: 'textile',
        fwc_id: null,
        title: 'Textile Level 2',
        description: 'Experienced worker with machine operation skills. You perform a range of production tasks with limited supervision.',
        duties: [
          'Operating production machinery such as sewing machines, looms, or knitting machines',
          'Performing quality checks on products during production',
          'Setting up and adjusting machines for different production runs',
          'Recording production data and reporting faults or defects',
        ],
        indicative_tasks: ['Machine operator', 'Production worker', 'Quality checker'],
        sort_order: 20,
      },
      {
        level: 3, stream: 'textile',
        fwc_id: null,
        title: 'Textile Level 3',
        description: 'Skilled machinist or cutter. You perform specialised production tasks requiring trade-level skills or equivalent experience.',
        duties: [
          'Operating specialised cutting, sewing, or finishing equipment',
          'Cutting fabric from patterns and templates with precision',
          'Performing complex sewing operations including garment assembly',
          'Troubleshooting machine issues and performing minor adjustments',
        ],
        indicative_tasks: ['Skilled machinist', 'Cutter', 'Garment maker'],
        sort_order: 30,
      },
      {
        level: 4, stream: 'textile',
        fwc_id: null,
        title: 'Textile Level 4',
        description: 'Advanced machinist or tradesperson. You have trade qualifications or equivalent experience and perform highly skilled production or technical work.',
        duties: [
          'Performing advanced pattern making, grading, and marker making',
          'Maintaining and repairing production machinery',
          'Training and mentoring less experienced workers',
          'Coordinating workflow within a production section',
        ],
        indicative_tasks: ['Advanced machinist', 'Tradesperson', 'Pattern maker'],
        sort_order: 40,
      },
      {
        level: 5, stream: 'textile',
        fwc_id: null,
        title: 'Textile Level 5',
        description: 'Supervisor or quality controller. You oversee production teams, manage quality assurance, and coordinate operations across your area.',
        duties: [
          'Supervising production teams and allocating work tasks',
          'Managing quality control processes and standards',
          'Planning and scheduling production runs',
          'Liaising with management on production targets and staffing requirements',
        ],
        indicative_tasks: ['Supervisor', 'Quality controller', 'Production coordinator'],
        sort_order: 50,
      },
    ];
    ...
    const baseRates = {
      textile: { 1: 25.44, 2: 26.12, 3: 27.04, 4: 28.26, 5: 29.62 },
    };
    ...
    const allowances = [
      ...
      },
      {
        ...
        description: 'If you are appointed as a first aid officer and hold a current first aid certificate, you are entitled to a first aid allowance of $16.78 per week.',
      ...
      },
      {
        ...
        description: 'If you are required to launder your own work clothing, you are entitled to a laundry allowance of $3.55 per week.',
        trigger_condition: 'Required to launder own work clothing',
    ...
    //   Q1: textile_level — level 1 through 5
    const questions = [
      {
        question_key: 'textile_level',
        question_text: 'What is your textile industry classification level?',
        help_text: 'Your level depends on your experience, qualifications, and the complexity of your duties. Level 1 is entry-level process work. Higher levels involve skilled machining, pattern making, supervision, and quality control.',
    ...
    const answers = [
      { question_key: 'textile_level', answer_key: 'l1', answer_text: 'Level 1 — Entry-level (process worker, packer, sorter)', sort_order: 1 },
      { question_key: 'textile_level', answer_key: 'l2', answer_text: 'Level 2 — Experienced (machine operator, production worker)', sort_order: 2 },
      { question_key: 'textile_level', answer_key: 'l3', answer_text: 'Level 3 — Skilled (machinist, cutter, garment maker)', sort_order: 3 },
      { question_key: 'textile_level', answer_key: 'l4', answer_text: 'Level 4 — Advanced (tradesperson, pattern maker)', sort_order: 4 },
      { question_key: 'textile_level', answer_key: 'l5', answer_text: 'Level 5 — Supervisor / quality controller', sort_order: 5 },
    ];
