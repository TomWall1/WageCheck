/**
 * Seed script — Silviculture Award 2020 [MA000070]
 * Pay rates effective 1 July 2025
 * Source: FWC MAPD API + FWO pay guide MA000040
 *
 * One stream:
 *   silviculture — Levels 1–5 (5 classifications)
 *
...
async function seed() {
  ...
  try {
    ...
    `, [
      ...
      EFFECTIVE_DATE,
      'https://awards.fairwork.gov.au/MA000070.html',
    ]);

    // ── Classifications ────────────────────────────────────────────────────────
    const classifications = [
      { level: 1, stream: 'silviculture', fwc_id: null, title: 'Silviculture Level 1', description: 'Entry-level forestry worker performing basic planting and maintenance tasks.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Silviculture Level 1'], sort_order: 10 },
      { level: 2, stream: 'silviculture', fwc_id: null, title: 'Silviculture Level 2', description: 'Experienced worker performing a range of silviculture operations.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Silviculture Level 2'], sort_order: 20 },
      { level: 3, stream: 'silviculture', fwc_id: null, title: 'Silviculture Level 3', description: 'Skilled worker operating forestry machinery and performing chemical applications.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Silviculture Level 3'], sort_order: 30 },
      { level: 4, stream: 'silviculture', fwc_id: null, title: 'Silviculture Level 4', description: 'Senior worker or tradesperson with advanced forestry skills.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Silviculture Level 4'], sort_order: 40 },
      { level: 5, stream: 'silviculture', fwc_id: null, title: 'Silviculture Level 5', description: 'Supervisor or foreperson coordinating silviculture operations.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Silviculture Level 5'], sort_order: 50 },
    ];
    ...
    //   Q1: silviculture_level — level 1 through 5
    const questions = [
      {
        question_key: 'silviculture_level',
        question_text: 'What is your silviculture classification level?',
        help_text: 'Your level depends on your experience and duties. Level 1 is entry-level forestry work. Higher levels involve skilled operations and supervision.',
    ...
    const answers = [
      { question_key: 'silviculture_level', answer_key: 'l1', answer_text: 'Level 1 — Entry-level (tree planter, general hand)', sort_order: 1 },
      { question_key: 'silviculture_level', answer_key: 'l2', answer_text: 'Level 2 — Experienced (pruner, brush cutter operator)', sort_order: 2 },
      { question_key: 'silviculture_level', answer_key: 'l3', answer_text: 'Level 3 — Skilled (chainsaw operator, chemical applicator)', sort_order: 3 },
      { question_key: 'silviculture_level', answer_key: 'l4', answer_text: 'Level 4 — Senior (heavy equipment operator, tradesperson)', sort_order: 4 },
      { question_key: 'silviculture_level', answer_key: 'l5', answer_text: 'Level 5 — Supervisor (foreperson, operations coordinator)', sort_order: 5 },
    ];
