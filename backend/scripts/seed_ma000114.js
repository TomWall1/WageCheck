/**
 * Seed script — Aquaculture Industry Award 2020 [MA000114]
 * Pay rates effective 1 July 2025 (following 2025 Annual Wage Review)
 * Rates sourced from FWC MAPD API.
 *
 * Run after migrate.js: node scripts/seed_ma000114.js
 */
require('dotenv').config();
const pool = require('../src/db/pool');

const AWARD_CODE = 'MA000114';
...
async function seed() {
  ...
  try {
    ...
    `, [
      ...
      EFFECTIVE_DATE,
      'https://www.fairwork.gov.au/employment-conditions/awards/awards-summary/ma000114-summary',
    ]);
    ...
    const classifications = [
      {
        ...
        title: 'Aquaculture Attendant Level 1',
        description: 'Entry-level aquaculture attendant performing basic farm duties including feeding, cleaning, and maintenance tasks under direct supervision.',
        duties: ['Feeding fish, shellfish, or other aquaculture species', 'Cleaning ponds, tanks, cages, and equipment', 'Assisting with harvesting and grading operations', 'Performing basic site maintenance and upkeep'],
        indicative_tasks: [],
        sort_order: 10,
      },
      {
        level: 2, stream: 'general',
        title: 'Aquaculture Attendant Level 2',
        description: 'Aquaculture attendant with developing skills performing a range of farming tasks including water quality monitoring and stock management.',
        duties: ['Monitoring and testing water quality parameters', 'Operating aquaculture equipment such as pumps and aerators', 'Assisting with stock health assessments and treatments', 'Performing grading, sorting, and packing of aquaculture products'],
        indicative_tasks: [],
        sort_order: 20,
      },
      {
        level: 3, stream: 'general',
        title: 'Aquaculture Attendant Level 3',
        description: 'Experienced aquaculture attendant performing skilled tasks including equipment operation, stock management, and quality control.',
        duties: ['Operating complex aquaculture systems and machinery', 'Managing stock health and administering treatments', 'Conducting detailed water quality analysis and adjustments', 'Training and guiding junior attendants on procedures'],
        indicative_tasks: [],
        sort_order: 30,
      },
      {
        level: 4, stream: 'general',
        title: 'Aquaculture Attendant Level 4',
        description: 'Senior aquaculture attendant or team leader performing advanced farming operations, supervisory duties, and ensuring compliance with industry standards.',
        duties: ['Supervising aquaculture teams and coordinating daily operations', 'Managing production schedules and harvest planning', 'Ensuring compliance with biosecurity and environmental regulations', 'Maintaining records and preparing production reports'],
        indicative_tasks: [],
        sort_order: 40,
      },
    ];
    ...
    const penaltyRates = [
      ...
      },
      {
        ...
        description: 'Monday to Saturday - after 3 hours — Casual ×1.6',
      },
      {
        employment_type: 'casual', day_type: 'sunday',
        time_band_start: null, time_band_end: null, time_band_label: null,
        multiplier: 1.6, addition_per_hour: null,
        description: 'Continuous shiftworkers - Monday to Sunday — Casual ×1.6',
      },
      {
        employment_type: 'casual', day_type: 'public_holiday',
        time_band_start: null, time_band_end: null, time_band_label: null,
        multiplier: 1.6, addition_per_hour: null,
        description: 'Continuous shiftworkers - Public holiday — Casual ×1.6',
      },
    ];
    ...
    const allowances = [
      {
        allowance_type: 'finfish_attendants_diving_equipment_in_a',
        name: 'Finfish attendants—diving equipment (in addition to diving allowance under clause 18.2(b))',
        description: 'Finfish attendants—diving equipment (in addition to diving allowance under clause 18.2(b))',
        trigger_condition: 'As per award conditions',
        amount: 6.81, amount_type: 'fixed', per_unit: 'per_hour',
      },
      {
        allowance_type: 'meal',
        name: 'Meal allowance—overtime of more than 2 hours—first meal',
        description: 'Meal allowance—overtime of more than 2 hours—first meal',
        trigger_condition: 'As per award conditions',
        amount: 21.81, amount_type: 'fixed', per_unit: 'per_shift',
      },
      {
        allowance_type: 'meal',
        name: 'Meal allowance—overtime of more than 2 hours—not required to work or less work than advised—surplus meal',
        description: 'Meal allowance—overtime of more than 2 hours—not required to work or less work than advised—surplus meal',
        trigger_condition: 'As per award conditions',
        amount: 21.81, amount_type: 'fixed', per_unit: 'per_shift',
      },
      {
        allowance_type: 'meal',
        name: 'Meal allowance—overtime of more than 2 hours—second/subsequent meal',
        description: 'Meal allowance—overtime of more than 2 hours—second/subsequent meal',
        trigger_condition: 'As per award conditions',
        amount: 21.81, amount_type: 'fixed', per_unit: 'per_shift',
      },
      {
        ...
        trigger_condition: 'As per award conditions',
        amount: 11.52, amount_type: 'weekly', per_unit: 'per_week',
      },
      {
        allowance_type: 'vehicle_car',
        name: 'Travelling time and allowance—use of private vehicle',
        description: 'Travelling time and allowance—use of private vehicle',
        trigger_condition: 'As per award conditions',
    ...
    const questions = [
      {
        ...
        sort_order: 1,
        answers: [
          { answer_key: 'level_1', answer_text: 'Aquaculture Attendant Level 1', sort_order: 1 },
          { answer_key: 'level_2', answer_text: 'Aquaculture Attendant Level 2', sort_order: 2 },
          { answer_key: 'level_3', answer_text: 'Aquaculture Attendant Level 3', sort_order: 3 },
          { answer_key: 'level_4', answer_text: 'Aquaculture Attendant Level 4', sort_order: 4 },
        ],
      },
    ];
