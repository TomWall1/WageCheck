/**
 * Seed script — Cement, Lime and Quarrying Award 2020 [MA000007]
 * Pay rates effective 1 July 2025
 * Source: FWC MAPD API + FWO pay guide MA000040
 *
 * One stream:
 *   cement_quarry — Levels 1–5 (5 classifications)
 *
...
async function seed() {
  ...
  try {
    ...
    `, [
      ...
      EFFECTIVE_DATE,
      'https://awards.fairwork.gov.au/MA000007.html',
    ]);

    // ── Classifications ────────────────────────────────────────────────────────
    const classifications = [
      { level: 1, stream: 'cement_quarry', fwc_id: null, title: 'Cement & Quarrying Level 1', description: 'Entry-level quarry or cement worker under direct supervision.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Cement & Quarrying Level 1'], sort_order: 10 },
      { level: 2, stream: 'cement_quarry', fwc_id: null, title: 'Cement & Quarrying Level 2', description: 'Experienced operator with basic machinery skills.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Cement & Quarrying Level 2'], sort_order: 20 },
      { level: 3, stream: 'cement_quarry', fwc_id: null, title: 'Cement & Quarrying Level 3', description: 'Skilled operator with heavy machinery independence.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Cement & Quarrying Level 3'], sort_order: 30 },
      { level: 4, stream: 'cement_quarry', fwc_id: null, title: 'Cement & Quarrying Level 4', description: 'Tradesperson or advanced operator with qualifications.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Cement & Quarrying Level 4'], sort_order: 40 },
      { level: 5, stream: 'cement_quarry', fwc_id: null, title: 'Cement & Quarrying Level 5', description: 'Leading hand or supervisor coordinating daily operations.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Cement & Quarrying Level 5'], sort_order: 50 },
    ];
    ...
    //   Q1: cement_quarry_level — level 1 through 5
    const questions = [
      {
        question_key: 'cement_quarry_level',
        question_text: 'What is your cement and quarrying classification level?',
        help_text: 'Your level depends on your experience and duties. Level 1 is entry-level quarry work. Higher levels involve operating heavy machinery and supervising.',
    ...
    const answers = [
      { question_key: 'cement_quarry_level', answer_key: 'l1', answer_text: 'Level 1 — Entry-level (quarry labourer, cement worker)', sort_order: 1 },
      { question_key: 'cement_quarry_level', answer_key: 'l2', answer_text: 'Level 2 — Experienced (crusher operator, screen operator)', sort_order: 2 },
      { question_key: 'cement_quarry_level', answer_key: 'l3', answer_text: 'Level 3 — Skilled (excavator operator, plant operator)', sort_order: 3 },
      { question_key: 'cement_quarry_level', answer_key: 'l4', answer_text: 'Level 4 — Tradesperson (kiln operator, maintenance fitter)', sort_order: 4 },
      { question_key: 'cement_quarry_level', answer_key: 'l5', answer_text: 'Level 5 — Supervisor (leading hand, shift supervisor)', sort_order: 5 },
    ];
