/**
 * Seed script — Pest Control Industry Award 2020 [MA000064]
 * Pay rates effective 1 July 2025
 * Source: FWC MAPD API + FWO pay guide MA000040
 *
 * One stream:
 *   pest_control — Levels 1–5 (5 classifications)
 *
...
async function seed() {
  ...
  try {
    ...
    `, [
      ...
      EFFECTIVE_DATE,
      'https://awards.fairwork.gov.au/MA000064.html',
    ]);

    // ── Classifications ────────────────────────────────────────────────────────
    const classifications = [
      { level: 1, stream: 'pest_control', fwc_id: null, title: 'Pest Control Level 1', description: 'Entry-level pest control assistant under direct supervision.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Pest Control Level 1'], sort_order: 10 },
      { level: 2, stream: 'pest_control', fwc_id: null, title: 'Pest Control Level 2', description: 'Experienced technician performing routine pest control treatments.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Pest Control Level 2'], sort_order: 20 },
      { level: 3, stream: 'pest_control', fwc_id: null, title: 'Pest Control Level 3', description: 'Licensed technician working independently on a range of pest management tasks.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Pest Control Level 3'], sort_order: 30 },
      { level: 4, stream: 'pest_control', fwc_id: null, title: 'Pest Control Level 4', description: 'Senior technician with advanced licences or specialist pest control duties.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Pest Control Level 4'], sort_order: 40 },
      { level: 5, stream: 'pest_control', fwc_id: null, title: 'Pest Control Level 5', description: 'Supervisor or manager coordinating pest control operations.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Pest Control Level 5'], sort_order: 50 },
    ];
    ...
    //   Q1: pest_control_level — level 1 through 5
    const questions = [
      {
        question_key: 'pest_control_level',
        question_text: 'What is your pest control classification level?',
        help_text: 'Your level depends on your experience and licence level. Level 1 is entry-level assistant work. Higher levels involve licensed technician and management roles.',
    ...
    const answers = [
      { question_key: 'pest_control_level', answer_key: 'l1', answer_text: 'Level 1 — Entry-level (assistant, trainee)', sort_order: 1 },
      { question_key: 'pest_control_level', answer_key: 'l2', answer_text: 'Level 2 — Experienced (technician, routine treatments)', sort_order: 2 },
      { question_key: 'pest_control_level', answer_key: 'l3', answer_text: 'Level 3 — Licensed (independent technician)', sort_order: 3 },
      { question_key: 'pest_control_level', answer_key: 'l4', answer_text: 'Level 4 — Senior (specialist technician, advanced licences)', sort_order: 4 },
      { question_key: 'pest_control_level', answer_key: 'l5', answer_text: 'Level 5 — Supervisor (operations manager)', sort_order: 5 },
    ];
