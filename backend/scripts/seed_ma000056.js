/**
 * Seed script — Concrete Products Award 2020 [MA000056]
 * Pay rates effective 1 July 2025 (following 2025 Annual Wage Review)
 * Rates sourced from FWC MAPD API.
 *
 * Run after migrate.js: node scripts/seed_ma000056.js
 */
require('dotenv').config();
const pool = require('../src/db/pool');

const AWARD_CODE = 'MA000056';
...
async function seed() {
  ...
  try {
    ...
    `, [
      ...
      EFFECTIVE_DATE,
      'https://www.fairwork.gov.au/employment-conditions/awards/awards-summary/ma000056-summary',
    ]);
    ...
    const classifications = [
      {
        ...
        title: 'Level 1',
        description: 'Entry-level concrete products manufacturing employee performing basic production, labouring, and cleaning tasks under direct supervision.',
        duties: ['Performing basic labouring tasks in production areas', 'Cleaning moulds, equipment, and work areas', 'Stacking and sorting concrete products', 'Assisting with raw material handling and loading'],
        indicative_tasks: [],
        sort_order: 10,
      },
      {
        ...
        title: 'Level 2',
        description: 'Concrete products employee with developing skills performing production tasks including machine operation and basic quality checks.',
        duties: ['Operating basic concrete production machinery', 'Performing quality checks on finished products', 'Mixing and batching concrete materials to specifications', 'Operating forklifts and materials handling equipment'],
        indicative_tasks: [],
        sort_order: 30,
      },
      {
        ...
        title: 'Level 3',
        description: 'Experienced concrete products employee performing skilled production tasks, operating complex machinery, and assisting with quality control.',
        duties: ['Operating complex concrete production equipment', 'Setting up moulds and production lines', 'Performing detailed quality control inspections', 'Training and guiding lower-level employees'],
        indicative_tasks: [],
        sort_order: 50,
      },
      {
        ...
        title: 'Level 4',
        description: 'Senior concrete products employee or tradesperson performing advanced production, maintenance, or supervisory duties.',
        duties: ['Performing trade-level maintenance on production equipment', 'Supervising production teams and allocating work', 'Troubleshooting production issues and equipment faults', 'Ensuring compliance with safety and quality standards'],
        indicative_tasks: [],
        sort_order: 70,
      },
      {
        ...
        title: 'Level 5',
        description: 'Advanced or specialist concrete products employee performing highly skilled production, technical, or supervisory duties with significant autonomy.',
        duties: ['Managing production schedules and resource allocation', 'Performing advanced technical and diagnostic work', 'Developing and implementing production procedures', 'Overseeing quality assurance programs and compliance'],
        indicative_tasks: [],
        sort_order: 90,
      },
    ];
    ...
    const penaltyRates = [
      ...
      },
      {
        ...
        time_band_start: null, time_band_end: null, time_band_label: null,
        multiplier: 2, addition_per_hour: null,
        description: 'Monday to Sunday - After 2 hours — Full-time ×2',
      },
      {
        employment_type: 'full_time', day_type: 'public_holiday',
        time_band_start: null, time_band_end: null, time_band_label: null,
        multiplier: 2, addition_per_hour: null,
        description: 'Monday to Sunday and public holidays — Full-time ×2',
      },
      {
      ...
      },
      {
        ...
        time_band_start: null, time_band_end: null, time_band_label: null,
        multiplier: 2, addition_per_hour: null,
        description: 'Monday to Sunday - After 2 hours — Part-time ×2',
      },
      {
        employment_type: 'part_time', day_type: 'public_holiday',
        time_band_start: null, time_band_end: null, time_band_label: null,
        multiplier: 2, addition_per_hour: null,
        description: 'Monday to Sunday and public holidays — Part-time ×2',
      },
      {
    ...
    const allowances = [
      {
        allowance_type: 'accommodation_allowance_for_any_subseque',
        name: 'Accommodation allowance—for any subsequent week or part thereof',
        description: 'Accommodation allowance—for any subsequent week or part thereof',
        trigger_condition: 'As per award conditions',
        amount: 816.84, amount_type: 'weekly', per_unit: 'per_week',
      },
      {
        allowance_type: 'accommodation_allowance_for_the_first_7_',
        name: 'Accommodation allowance—for the first 7 days',
        description: 'Accommodation allowance—for the first 7 days',
        trigger_condition: 'As per award conditions',
        amount: 116.76, amount_type: 'fixed', per_unit: 'per_shift',
      },
      {
        allowance_type: 'boot_allowance',
        name: 'Boot allowance',
        description: 'Boot allowance',
        trigger_condition: 'As per award conditions',
        amount: 3.2, amount_type: 'weekly', per_unit: 'per_week',
      },
      {
        ...
        trigger_condition: 'As per award conditions',
        amount: 2.6, amount_type: 'weekly', per_unit: 'per_week',
      },
      {
        allowance_type: 'uniform',
        name: 'Loss of clothing—up to a maximum amount of',
        description: 'Loss of clothing—up to a maximum amount of',
        trigger_condition: 'As per award conditions',
        amount: 746.9, amount_type: 'fixed', per_unit: 'per_shift',
      },
      {
        allowance_type: 'meal',
        name: 'Meal allowance',
        ...
        trigger_condition: 'As per award conditions',
        amount: 19.71, amount_type: 'fixed', per_unit: 'per_shift',
      },
    ];
