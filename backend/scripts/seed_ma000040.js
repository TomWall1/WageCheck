/**
 * Seed script — Sugar Industry Award 2020 [MA000040]
 * Pay rates effective 1 July 2025
 * Source: FWC MAPD API + FWO pay guide MA000040
 *
 * One stream:
 *   sugar — Levels 1–5 (5 classifications)
 *
 ...
 *   Meal: $20.96
 *
 * Run after migrate.js: node scripts/seed_ma000040.js
 */
require('dotenv').config();
const pool = require('../src/db/pool');

const AWARD_CODE = 'MA000040';
...
async function seed() {
  ...
  try {
    ...
    `, [
      ...
      EFFECTIVE_DATE,
      'https://awards.fairwork.gov.au/MA000040.html',
    ]);

    // ── Classifications ────────────────────────────────────────────────────────
    const classifications = [
      {
        level: 1, stream: 'sugar',
        fwc_id: null,
        title: 'Sugar Industry Level 1',
        description: 'Entry-level sugar industry worker. You perform basic tasks under direct supervision, including harvesting support and general mill duties.',
        duties: [
          'Performing basic harvesting tasks such as gathering and loading cane',
          'Carrying out general labouring duties in sugar mills or refineries',
          'Cleaning and maintaining work areas and basic equipment',
          'Following instructions and working under direct supervision',
        ],
        indicative_tasks: ['Cane harvester (entry)', 'Mill labourer', 'General hand'],
        sort_order: 10,
      },
      {
        level: 2, stream: 'sugar',
        fwc_id: null,
        title: 'Sugar Industry Level 2',
        description: 'Experienced sugar industry worker. You perform a range of tasks with limited supervision and operate basic machinery.',
        duties: [
          'Operating basic harvesting and field machinery under guidance',
          'Performing routine processing tasks in mills and refineries',
          'Maintaining and checking equipment before and after use',
          'Assisting with transport and storage of raw materials',
        ],
        indicative_tasks: ['Machine operator (basic)', 'Field worker (experienced)', 'Process worker'],
        sort_order: 20,
      },
      {
        level: 3, stream: 'sugar',
        fwc_id: null,
        title: 'Sugar Industry Level 3',
        description: 'Skilled sugar industry operator. You operate mill and refinery equipment and work with minimal supervision on routine operations.',
        duties: [
          'Operating mill crushing, evaporation, or centrifugal equipment',
          'Monitoring refinery processes and adjusting settings as required',
          'Performing quality checks on sugar products during processing',
          'Completing operational logs and reporting production data',
        ],
        indicative_tasks: ['Mill operator', 'Refinery operator', 'Quality checker'],
        sort_order: 30,
      },
      {
        level: 4, stream: 'sugar',
        fwc_id: null,
        title: 'Sugar Industry Level 4',
        description: 'Tradesperson or advanced operator in the sugar industry. You hold trade qualifications or equivalent experience and perform specialised work.',
        duties: [
          'Performing trade-level maintenance on milling and refinery equipment',
          'Operating advanced or specialised processing machinery',
          'Diagnosing equipment faults and carrying out repairs',
          'Training and mentoring lower-level employees in operational tasks',
        ],
        indicative_tasks: ['Tradesperson (fitter/boilermaker)', 'Senior mill operator', 'Maintenance technician'],
        sort_order: 40,
      },
      {
        level: 5, stream: 'sugar',
        fwc_id: null,
        title: 'Sugar Industry Level 5',
        description: 'Leading hand or supervisor in the sugar industry. You coordinate work teams and oversee daily operations in harvesting, milling, or refinery areas.',
        duties: [
          'Supervising work teams during harvesting, milling, or refinery operations',
          'Coordinating daily work schedules and allocating tasks',
        ...
        indicative_tasks: ['Leading hand', 'Shift supervisor', 'Operations coordinator'],
        sort_order: 50,
      },
    ];
    ...
    const baseRates = {
      sugar: { 1: 25.44, 2: 26.27, 3: 27.04, 4: 28.26, 5: 29.62 },
    };
    ...
    //   Q1: sugar_level — level 1 through 5
    const questions = [
      {
        question_key: 'sugar_level',
        question_text: 'What is your sugar industry classification level?',
        help_text: 'Your level depends on your experience, qualifications, and the complexity of your duties. Level 1 is entry-level harvesting and mill work. Higher levels involve operating machinery, trade-level maintenance, and supervising teams.',
    ...
    const answers = [
      { question_key: 'sugar_level', answer_key: 'l1', answer_text: 'Level 1 — Entry-level (cane harvester, mill labourer, general hand)', sort_order: 1 },
      { question_key: 'sugar_level', answer_key: 'l2', answer_text: 'Level 2 — Experienced (basic machine operator, field worker, process worker)', sort_order: 2 },
      { question_key: 'sugar_level', answer_key: 'l3', answer_text: 'Level 3 — Skilled (mill operator, refinery operator, quality checker)', sort_order: 3 },
      { question_key: 'sugar_level', answer_key: 'l4', answer_text: 'Level 4 — Tradesperson/advanced (fitter, boilermaker, maintenance technician)', sort_order: 4 },
      { question_key: 'sugar_level', answer_key: 'l5', answer_text: 'Level 5 — Leading hand/supervisor (shift supervisor, operations coordinator)', sort_order: 5 },
    ];
