/**
 * Seed script — Premixed Concrete Award 2020 [MA000045]
 * Pay rates effective 1 July 2025
 * Source: FWC MAPD API + FWO pay guide MA000045
 *
 * One stream:
 *   concrete — Levels 1–5 (5 classifications)
 *
 * Adult FT/PT hourly rates:
 *   L1: $25.65   L2: $26.58   L3: $27.52   L4: $28.95   L5: $30.12
 *
 ...
 *
 * Allowances:
 *   Meal: $20.96 (overtime >2 hours)
 *
 * Run after migrate.js: node scripts/seed_ma000045.js
 */
require('dotenv').config();
const pool = require('../src/db/pool');

const AWARD_CODE = 'MA000045';
...
async function seed() {
  ...
  try {
    ...
    `, [
      ...
      EFFECTIVE_DATE,
      'https://awards.fairwork.gov.au/MA000045.html',
    ]);

    // ── Classifications ────────────────────────────────────────────────────────
    const classifications = [
      {
        level: 1, stream: 'concrete',
        fwc_id: null,
        title: 'Premixed Concrete Level 1',
        description: 'Entry-level premixed concrete employee. You perform routine tasks under direct supervision, including basic batching and yard duties.',
        duties: [
          'Performing basic batching operations under supervision',
          'Carrying out yardperson duties including stockpile maintenance',
          'Cleaning and maintaining plant equipment and work areas',
          'Loading and unloading materials as directed',
        ],
        indicative_tasks: ['Batcher (entry)', 'Yardperson', 'Plant labourer'],
        sort_order: 10,
      },
      {
        level: 2, stream: 'concrete',
        fwc_id: null,
        title: 'Premixed Concrete Level 2',
        description: 'Experienced premixed concrete employee. You operate vehicles and equipment with limited supervision and have developed practical skills.',
        duties: [
          'Operating agitator trucks to deliver premixed concrete to sites',
          'Performing quality checks on concrete mixes during delivery',
          'Communicating with dispatch and site personnel on delivery requirements',
          'Maintaining delivery vehicles and completing pre-start checks',
        ],
        indicative_tasks: ['Agitator driver', 'Experienced batcher', 'Plant operator'],
        sort_order: 20,
      },
      {
        level: 3, stream: 'concrete',
        fwc_id: null,
        title: 'Premixed Concrete Level 3',
        description: 'Skilled premixed concrete employee. You operate specialised equipment and work with minimal supervision on complex tasks.',
        duties: [
          'Operating boom pump equipment on construction sites',
          'Managing concrete placement and pumping operations',
          'Performing advanced batching including mix design adjustments',
          'Training and mentoring less experienced operators',
        ],
        indicative_tasks: ['Boom pump operator', 'Senior agitator driver', 'Skilled plant operator'],
        sort_order: 30,
      },
      {
        level: 4, stream: 'concrete',
        fwc_id: null,
        title: 'Premixed Concrete Level 4',
        description: 'Tradesperson or advanced operator in premixed concrete. You hold relevant trade qualifications or have equivalent experience and expertise.',
        duties: [
          'Performing mechanical maintenance and repairs on plant and vehicles',
          'Managing quality control testing and compliance procedures',
          'Operating and maintaining specialised concrete production equipment',
          'Implementing and monitoring safety systems and procedures',
        ],
        indicative_tasks: ['Tradesperson', 'Advanced plant operator', 'Quality control technician'],
        sort_order: 40,
      },
      {
        level: 5, stream: 'concrete',
        fwc_id: null,
        title: 'Premixed Concrete Level 5',
        description: 'Leading hand or supervisor in premixed concrete operations. You coordinate and supervise the work of other employees and manage daily operations.',
        duties: [
          'Supervising and coordinating batching, delivery, and pumping teams',
          'Managing daily scheduling and dispatch operations',
          'Ensuring compliance with safety, environmental, and quality standards',
          'Liaising with clients and site managers on delivery requirements',
        ],
        indicative_tasks: ['Leading hand', 'Supervisor', 'Dispatch coordinator'],
        sort_order: 50,
      },
    ];
    ...
    // ── Pay rates ──────────────────────────────────────────────────────────────
    // Source: FWO pay guide MA000045.
    // Casual rate = FT rate × 1.25.
    const baseRates = {
      concrete: { 1: 25.65, 2: 26.58, 3: 27.52, 4: 28.95, 5: 30.12 },
    };
    ...
    //   Q1: concrete_level — level 1 through 5
    const questions = [
      {
        question_key: 'concrete_level',
        question_text: 'What is your premixed concrete classification level?',
        help_text: 'Your level depends on your experience, qualifications, and the complexity of your duties. Level 1 is entry-level batching and yard work. Higher levels involve driving agitators, operating boom pumps, trade qualifications, and supervisory roles.',
    ...
    const answers = [
      { question_key: 'concrete_level', answer_key: 'l1', answer_text: 'Level 1 — Entry-level (batcher, yardperson, plant labourer)', sort_order: 1 },
      { question_key: 'concrete_level', answer_key: 'l2', answer_text: 'Level 2 — Experienced operator (agitator driver, experienced batcher)', sort_order: 2 },
      { question_key: 'concrete_level', answer_key: 'l3', answer_text: 'Level 3 — Skilled operator (boom pump operator, senior agitator driver)', sort_order: 3 },
      { question_key: 'concrete_level', answer_key: 'l4', answer_text: 'Level 4 — Tradesperson / advanced operator (quality control technician)', sort_order: 4 },
      { question_key: 'concrete_level', answer_key: 'l5', answer_text: 'Level 5 — Leading hand / supervisor (dispatch coordinator)', sort_order: 5 },
    ];
