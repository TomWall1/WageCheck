    ...
    const classifications = [
      {
        ...
        duties: ['Presenting garments and merchandise professionally', 'Following direction from designers and choreographers', 'Maintaining appearance and presentation standards'],
        indicative_tasks: [],
        sort_order: 10,
      },
      {
      ...
      },
      {
        ...
        description: 'Payment for mannequins and models attending fitting sessions where garments are fitted and selected for upcoming showings.',
        duties: ['Attending fitting sessions and trying on garments', 'Standing for alterations and measurements', 'Providing feedback on garment fit and comfort'],
        indicative_tasks: [],
        sort_order: 40,
      },
      {
      ...
      },
      {
        ...
        description: 'Model engaged for still photography, television, or movie appearances for one hour or part thereof.',
        duties: ['Posing for still photography or screen appearances', 'Following direction from photographers and directors', 'Changing outfits and maintaining appearance between shots'],
        indicative_tasks: [],
        sort_order: 90,
      },
      {
      ...
      },
      {
        ...
        title: 'Up to 2 hours',
        description: 'Model engaged for still photography, television, or movie appearances for up to 2 hours.',
        duties: ['Performing in extended photography or screen sessions', 'Performing multiple outfit changes during the session', 'Following creative direction for varied shots and scenes'],
        indicative_tasks: [],
        sort_order: 180,
      },
      {
      ...
      },
      {
        ...
        title: 'Up to 4 hours',
        description: 'Model engaged for still photography, television, or movie appearances for up to 4 hours.',
        duties: ['Performing in extended photography or screen sessions', 'Adapting to multiple scenes, locations, and creative directions', 'Managing energy and appearance over half-day sessions'],
        indicative_tasks: [],
        sort_order: 240,
      },
      {
      ...
      },
      {
        ...
        title: 'Half day rate',
        description: 'Model engaged for still photography, television, or movie appearances at the half-day rate.',
        duties: ['Performing professional modelling for half-day media sessions', 'Working with photographers, stylists, and creative directors', 'Managing wardrobe, hair, and makeup across the session'],
        indicative_tasks: [],
        sort_order: 260,
      },
      {
      ...
      },
      {
        ...
        title: 'Full day rate',
        description: 'Model engaged for still photography, television, or movie appearances at the full-day rate.',
        duties: ['Performing professional modelling for full-day media sessions', 'Working across multiple scenes, setups, and creative briefs', 'Maintaining professional appearance and energy throughout the day'],
        indicative_tasks: [],
        sort_order: 280,
      },
      {
