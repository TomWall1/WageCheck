/**
 * Seed script — Stevedoring Industry Award 2020 [MA000078]
 * Pay rates effective 1 July 2025
 * Source: FWC MAPD API + FWO pay guide MA000040
 *
 * One stream:
 *   stevedoring — Levels 1–5 (5 classifications)
 *
...
async function seed() {
  ...
  try {
    ...
    `, [
      ...
      EFFECTIVE_DATE,
      'https://awards.fairwork.gov.au/MA000078.html',
    ]);

    // ── Classifications ────────────────────────────────────────────────────────
    const classifications = [
      { level: 1, stream: 'stevedoring', fwc_id: null, title: 'Stevedore Level 1', description: 'Entry-level stevedore performing basic loading and unloading tasks.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Stevedore Level 1'], sort_order: 10 },
      { level: 2, stream: 'stevedoring', fwc_id: null, title: 'Stevedore Level 2', description: 'Experienced stevedore operating forklifts and basic wharf equipment.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Stevedore Level 2'], sort_order: 20 },
      { level: 3, stream: 'stevedoring', fwc_id: null, title: 'Stevedore Level 3', description: 'Skilled operator managing container cranes and specialised equipment.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Stevedore Level 3'], sort_order: 30 },
      { level: 4, stream: 'stevedoring', fwc_id: null, title: 'Stevedore Level 4', description: 'Senior operator or tradesperson with advanced stevedoring duties.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Stevedore Level 4'], sort_order: 40 },
      { level: 5, stream: 'stevedoring', fwc_id: null, title: 'Stevedore Level 5', description: 'Foreman or supervisor coordinating wharf and vessel operations.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Stevedore Level 5'], sort_order: 50 },
    ];
    ...
    //   Q1: stevedoring_level — level 1 through 5
    const questions = [
      {
        question_key: 'stevedoring_level',
        question_text: 'What is your stevedoring classification level?',
        help_text: 'Your level depends on your experience and qualifications. Level 1 is entry-level wharf work. Higher levels involve crane operation, foreman, and supervisory roles.',
    ...
    const answers = [
      { question_key: 'stevedoring_level', answer_key: 'l1', answer_text: 'Level 1 — Entry-level (wharf labourer, general stevedore)', sort_order: 1 },
      { question_key: 'stevedoring_level', answer_key: 'l2', answer_text: 'Level 2 — Experienced (forklift operator, lashing hand)', sort_order: 2 },
      { question_key: 'stevedoring_level', answer_key: 'l3', answer_text: 'Level 3 — Skilled (crane operator, straddle carrier driver)', sort_order: 3 },
      { question_key: 'stevedoring_level', answer_key: 'l4', answer_text: 'Level 4 — Senior (ship planner, tradesperson)', sort_order: 4 },
      { question_key: 'stevedoring_level', answer_key: 'l5', answer_text: 'Level 5 — Supervisor (foreman, operations coordinator)', sort_order: 5 },
    ];
