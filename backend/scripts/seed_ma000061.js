/**
 * Seed script — Airline Operations—Ground Staff Award 2020 [MA000061]
 * Pay rates effective 1 July 2025
 * Source: FWC MAPD API + FWO pay guide MA000040
 *
 * One stream:
 *   airline_ground — Levels 1–5 (5 classifications)
 *
...
async function seed() {
  ...
  try {
    ...
    `, [
      ...
      EFFECTIVE_DATE,
      'https://awards.fairwork.gov.au/MA000061.html',
    ]);

    // ── Classifications ────────────────────────────────────────────────────────
    const classifications = [
      { level: 1, stream: 'airline_ground', fwc_id: null, title: 'Ground Staff Level 1', description: 'Entry-level ground handling staff performing basic ramp and terminal duties.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Ground Staff Level 1'], sort_order: 10 },
      { level: 2, stream: 'airline_ground', fwc_id: null, title: 'Ground Staff Level 2', description: 'Experienced ground staff handling baggage, cargo, or check-in operations.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Ground Staff Level 2'], sort_order: 20 },
      { level: 3, stream: 'airline_ground', fwc_id: null, title: 'Ground Staff Level 3', description: 'Skilled operator managing specialised ground equipment or customer service.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Ground Staff Level 3'], sort_order: 30 },
      { level: 4, stream: 'airline_ground', fwc_id: null, title: 'Ground Staff Level 4', description: 'Senior operator or team leader with advanced duties.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Ground Staff Level 4'], sort_order: 40 },
      { level: 5, stream: 'airline_ground', fwc_id: null, title: 'Ground Staff Level 5', description: 'Supervisor coordinating ground operations across shifts or terminals.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Ground Staff Level 5'], sort_order: 50 },
    ];
    ...
    //   Q1: airline_ground_level — level 1 through 5
    const questions = [
      {
        question_key: 'airline_ground_level',
        question_text: 'What is your airline ground staff classification level?',
        help_text: 'Your level depends on your role and experience. Level 1 is entry-level ground handling. Higher levels involve specialist and supervisory roles.',
    ...
    const answers = [
      { question_key: 'airline_ground_level', answer_key: 'l1', answer_text: 'Level 1 — Entry-level (ramp handler, trolley collector)', sort_order: 1 },
      { question_key: 'airline_ground_level', answer_key: 'l2', answer_text: 'Level 2 — Experienced (baggage handler, check-in agent)', sort_order: 2 },
      { question_key: 'airline_ground_level', answer_key: 'l3', answer_text: 'Level 3 — Skilled (equipment operator, customer service lead)', sort_order: 3 },
      { question_key: 'airline_ground_level', answer_key: 'l4', answer_text: 'Level 4 — Senior (team leader, load controller)', sort_order: 4 },
      { question_key: 'airline_ground_level', answer_key: 'l5', answer_text: 'Level 5 — Supervisor (shift coordinator, operations supervisor)', sort_order: 5 },
    ];
