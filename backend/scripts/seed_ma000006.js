/**
 * Seed script — Black Coal Mining Industry Award 2020 [MA000006]
 * Pay rates effective 1 July 2025
 * Source: FWC MAPD API + FWO pay guide MA000040
 *
 * One stream:
 *   coal_mining — Levels 1–5 (5 classifications)
 *
 * Adult FT/PT hourly rates:
 *   L1: $27.98   L2: $29.12   L3: $30.44   L4: $31.82   L5: $33.68
 *
...
async function seed() {
  ...
  try {
    ...
    `, [
      ...
      EFFECTIVE_DATE,
      'https://awards.fairwork.gov.au/MA000006.html',
    ]);

    // ── Classifications ────────────────────────────────────────────────────────
    const classifications = [
      { level: 1, stream: 'coal_mining', fwc_id: null, title: 'Production/Engineering Employee Level 1', description: 'Entry-level mineworker. You perform basic tasks under direct supervision.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Production/Engineering Employee Level 1'], sort_order: 10 },
      { level: 2, stream: 'coal_mining', fwc_id: null, title: 'Production/Engineering Employee Level 2', description: 'Experienced mineworker. You operate basic mining equipment with limited supervision.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Production/Engineering Employee Level 2'], sort_order: 20 },
      { level: 3, stream: 'coal_mining', fwc_id: null, title: 'Production/Engineering Employee Level 3', description: 'Skilled mineworker. You operate heavy equipment independently.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Production/Engineering Employee Level 3'], sort_order: 30 },
      { level: 4, stream: 'coal_mining', fwc_id: null, title: 'Production/Engineering Employee Level 4', description: 'Tradesperson or equivalent. You perform complex maintenance requiring trade qualifications.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Production/Engineering Employee Level 4'], sort_order: 40 },
      { level: 5, stream: 'coal_mining', fwc_id: null, title: 'Production/Engineering Employee Level 5', description: 'Advanced tradesperson or supervisor. You coordinate work teams.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Production/Engineering Employee Level 5'], sort_order: 50 },
    ];
    ...
    //   Q1: coal_mining_level — level 1 through 5
    const questions = [
      {
        question_key: 'coal_mining_level',
        question_text: 'What is your black coal mining classification level?',
        help_text: 'Your level depends on your experience, qualifications, and duties. Level 1 is entry-level labouring. Higher levels involve operating heavy equipment, trade qualifications, and supervising crews.',
    ...
    const answers = [
      { question_key: 'coal_mining_level', answer_key: 'l1', answer_text: 'Level 1 — Entry-level (mine labourer, pit hand)', sort_order: 1 },
      { question_key: 'coal_mining_level', answer_key: 'l2', answer_text: 'Level 2 — Experienced (conveyor operator, loader operator)', sort_order: 2 },
      { question_key: 'coal_mining_level', answer_key: 'l3', answer_text: 'Level 3 — Skilled (excavator operator, haul truck driver)', sort_order: 3 },
      { question_key: 'coal_mining_level', answer_key: 'l4', answer_text: 'Level 4 — Tradesperson (mine fitter, electrician, shot firer)', sort_order: 4 },
      { question_key: 'coal_mining_level', answer_key: 'l5', answer_text: 'Level 5 — Supervisor (leading hand, shift supervisor, mine deputy)', sort_order: 5 },
    ];
