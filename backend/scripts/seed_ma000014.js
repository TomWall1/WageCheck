/**
 * Seed script — Mining Industry Award 2020 [MA000014]
 * Pay rates effective 1 July 2025
 * Source: FWC MAPD API + FWO pay guide MA000040
 *
 * One stream:
 *   mining — Levels 1–5 (5 classifications)
 *
 * Adult FT/PT hourly rates:
 *   L1: $27.04   L2: $28.26   L3: $29.62   L4: $31.18   L5: $33.18
 *
...
async function seed() {
  ...
  try {
    ...
    `, [
      ...
      EFFECTIVE_DATE,
      'https://awards.fairwork.gov.au/MA000014.html',
    ]);

    // ── Classifications ────────────────────────────────────────────────────────
    const classifications = [
      { level: 1, stream: 'mining', fwc_id: null, title: 'Mineworker Level 1', description: 'Entry-level mineworker. Basic underground or surface tasks under supervision.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Mineworker Level 1'], sort_order: 10 },
      { level: 2, stream: 'mining', fwc_id: null, title: 'Mineworker Level 2', description: 'Experienced mineworker operating basic equipment.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Mineworker Level 2'], sort_order: 20 },
      { level: 3, stream: 'mining', fwc_id: null, title: 'Mineworker Level 3', description: 'Skilled mine operator with heavy equipment independence.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Mineworker Level 3'], sort_order: 30 },
      { level: 4, stream: 'mining', fwc_id: null, title: 'Mineworker Level 4', description: 'Tradesperson with qualifications performing specialised work.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Mineworker Level 4'], sort_order: 40 },
      { level: 5, stream: 'mining', fwc_id: null, title: 'Mineworker Level 5', description: 'Senior tradesperson or supervisor coordinating operations.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Mineworker Level 5'], sort_order: 50 },
    ];
    ...
    //   Q1: mining_level — level 1 through 5
    const questions = [
      {
        question_key: 'mining_level',
        question_text: 'What is your mining industry classification level?',
        help_text: 'Your level depends on your experience and duties. Level 1 is entry-level mining work. Higher levels involve operating heavy equipment, trade qualifications, and supervising.',
    ...
    const answers = [
      { question_key: 'mining_level', answer_key: 'l1', answer_text: 'Level 1 — Entry-level (mine labourer, surface hand)', sort_order: 1 },
      { question_key: 'mining_level', answer_key: 'l2', answer_text: 'Level 2 — Experienced (loader operator, truck driver)', sort_order: 2 },
      { question_key: 'mining_level', answer_key: 'l3', answer_text: 'Level 3 — Skilled (bogger operator, jumbo operator, driller)', sort_order: 3 },
      { question_key: 'mining_level', answer_key: 'l4', answer_text: 'Level 4 — Tradesperson (mine fitter, electrician, shot firer)', sort_order: 4 },
      { question_key: 'mining_level', answer_key: 'l5', answer_text: 'Level 5 — Supervisor (shift boss, mine supervisor)', sort_order: 5 },
    ];
