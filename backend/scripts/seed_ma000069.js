    ...
    const classifications = [
      {
        ...
        description: 'Grade 1—on commencement',
        duties: [],
        indicative_tasks: [],
        sort_order: 10,
      },
      ...
      },
      {
        ...
        description: 'Grade 1—after 3 months',
        duties: [],
        indicative_tasks: [],
        sort_order: 30,
      },
      ...
      },
      {
        ...
        description: 'Grade 1—after 12 months',
        duties: [],
        indicative_tasks: [],
        sort_order: 50,
      },
      ...
      },
      {
        ...
        description: 'Manufacturing/production worker',
        duties: [],
        indicative_tasks: [],
        sort_order: 130,
      },
      {
        ...
        description: 'Warehouse/distribution worker',
        duties: [],
        indicative_tasks: [],
        sort_order: 140,
      },
    ...
    const questions = [
      {
        ...
        answers: [
          ...
          { answer_key: 'level_1', answer_text: 'Grade 1—on commencement', sort_order: 2 },
          { answer_key: 'level_2', answer_text: 'Grade 1—after 3 months', sort_order: 3 },
          { answer_key: 'level_2', answer_text: 'Grade 1—after 3 months', sort_order: 4 },
          { answer_key: 'level_3', answer_text: 'Grade 1—after 12 months', sort_order: 5 },
          { answer_key: 'level_3', answer_text: 'Grade 1—after 12 months', sort_order: 6 },
          { answer_key: 'level_4', answer_text: 'Grade 2', sort_order: 7 },
          { answer_key: 'level_4', answer_text: 'Grade 2', sort_order: 8 },
          { answer_key: 'level_5', answer_text: 'Grade 3', sort_order: 9 },
          { answer_key: 'level_5', answer_text: 'Grade 3', sort_order: 10 },
          { answer_key: 'level_6', answer_text: 'Grade 4', sort_order: 11 },
          { answer_key: 'level_6', answer_text: 'Grade 4', sort_order: 12 },
          { answer_key: 'level_13', answer_text: 'Manufacturing/production worker', sort_order: 13 },
          { answer_key: 'level_14', answer_text: 'Warehouse/distribution worker', sort_order: 14 },
        ],
      },
    ];
