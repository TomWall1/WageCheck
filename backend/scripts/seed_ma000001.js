/**
 * Seed script — Aboriginal Community Controlled Health Services Award 2020 [MA000001]
 * Pay rates effective 1 July 2025
 * Source: FWC MAPD API + FWO pay guide MA000040
 *
 * One stream:
 *   health_services — Levels 1–7 (7 classifications)
 *
...
async function seed() {
  ...
  try {
    ...
    `, [
      ...
      EFFECTIVE_DATE,
      'https://awards.fairwork.gov.au/MA000001.html',
    ]);

    // ── Classifications ────────────────────────────────────────────────────────
    const classifications = [
      { level: 1, stream: 'health_services', fwc_id: null, title: 'Health Worker Level 1', description: 'Entry-level health support worker under direct supervision.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Health Worker Level 1'], sort_order: 10 },
      { level: 2, stream: 'health_services', fwc_id: null, title: 'Health Worker Level 2', description: 'Experienced health worker performing routine clinical support tasks.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Health Worker Level 2'], sort_order: 20 },
      { level: 3, stream: 'health_services', fwc_id: null, title: 'Health Worker Level 3', description: 'Qualified health worker delivering primary health care services.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Health Worker Level 3'], sort_order: 30 },
      { level: 4, stream: 'health_services', fwc_id: null, title: 'Health Worker Level 4', description: 'Senior health worker with advanced clinical skills.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Health Worker Level 4'], sort_order: 40 },
      { level: 5, stream: 'health_services', fwc_id: null, title: 'Health Worker Level 5', description: 'Team leader coordinating health programs and staff.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Health Worker Level 5'], sort_order: 50 },
      { level: 6, stream: 'health_services', fwc_id: null, title: 'Health Worker Level 6', description: 'Senior practitioner or program manager.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Health Worker Level 6'], sort_order: 60 },
      { level: 7, stream: 'health_services', fwc_id: null, title: 'Health Worker Level 7', description: 'Manager overseeing multiple health programs or a health service.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Health Worker Level 7'], sort_order: 70 },
    ];
    ...
    //   Q1: acch_level — level 1 through 5
    const questions = [
      {
        question_key: 'acch_level',
        question_text: 'What is your health services classification level?',
        help_text: 'Your level depends on your experience, qualifications, and duties. Level 1 is entry-level support work. Higher levels involve clinical qualifications and management.',
    ...
    const answers = [
      { question_key: 'acch_level', answer_key: 'l1', answer_text: 'Level 1 — Entry-level (health support worker)', sort_order: 1 },
      { question_key: 'acch_level', answer_key: 'l2', answer_text: 'Level 2 — Experienced (clinical support worker)', sort_order: 2 },
      { question_key: 'acch_level', answer_key: 'l3', answer_text: 'Level 3 — Qualified (primary health care worker)', sort_order: 3 },
      { question_key: 'acch_level', answer_key: 'l4', answer_text: 'Level 4 — Senior (advanced clinical worker)', sort_order: 4 },
      { question_key: 'acch_level', answer_key: 'l5', answer_text: 'Level 5 — Team leader (program coordinator)', sort_order: 5 },
      { question_key: 'acch_level', answer_key: 'l6', answer_text: 'Level 6 — Senior practitioner/program manager', sort_order: 6 },
      { question_key: 'acch_level', answer_key: 'l7', answer_text: 'Level 7 — Manager (health service manager)', sort_order: 7 },
    ];
