/**
 * Seed script — Salt Industry Award 2020 [MA000107]
 * Pay rates effective 1 July 2025 (following 2025 Annual Wage Review)
 * Rates sourced from FWC MAPD API.
 *
 * Run after migrate.js: node scripts/seed_ma000107.js
 */
require('dotenv').config();
const pool = require('../src/db/pool');

const AWARD_CODE = 'MA000107';
...
async function seed() {
  ...
  try {
    ...
    `, [
      ...
      EFFECTIVE_DATE,
      'https://www.fairwork.gov.au/employment-conditions/awards/awards-summary/ma000107-summary',
    ]);

    // ── Classifications ───────────────────────────────────────────────────────
    const classifications = [
      {
        level: 1, stream: 'junior_employees',
        title: 'At 17 years',
        description: 'Junior salt industry employee aged 17 years, performing basic production and labouring duties at a junior rate of pay.',
        duties: ['Performing basic production and labouring tasks under supervision', 'Assisting with salt harvesting and processing operations', 'Maintaining cleanliness of work areas and equipment'],
        indicative_tasks: [],
        sort_order: 10,
      },
      {
        level: 1, stream: 'junior_employees',
        title: 'At 18 years',
        description: 'Junior salt industry employee aged 18 years, performing basic production and labouring duties at a junior rate of pay.',
        duties: ['Performing basic production and labouring tasks under supervision', 'Assisting with salt harvesting and processing operations', 'Operating basic equipment under guidance'],
        indicative_tasks: [],
        sort_order: 20,
      },
      {
        level: 1, stream: 'junior_employees',
        title: 'At 19 years',
        description: 'Junior salt industry employee aged 19 years, performing production duties with developing skills at a junior rate of pay.',
        duties: ['Performing production tasks with increasing independence', 'Operating basic salt processing equipment', 'Assisting experienced workers with operational tasks'],
        indicative_tasks: [],
        sort_order: 30,
      },
      {
        level: 1, stream: 'general',
        title: 'Level 1\u2014Introductory',
        description: 'Entry-level salt industry employee at the introductory level, performing basic production, labouring, and site maintenance duties under direct supervision.',
        duties: ['Performing basic salt harvesting and production tasks', 'Cleaning and maintaining processing equipment and areas', 'Assisting with loading, unloading, and stockpiling salt', 'Following safety procedures and wearing required PPE'],
        indicative_tasks: [],
        sort_order: 40,
      },
      {
        level: 1, stream: 'junior_employees',
        title: 'Under 17 years',
        description: 'Junior salt industry employee under 17 years of age, performing the most basic duties at a junior rate of pay.',
        duties: ['Performing basic labouring tasks under close supervision', 'Assisting with cleaning and tidying work areas', 'Learning workplace safety and operational procedures'],
        indicative_tasks: [],
        sort_order: 60,
      },
      {
        ...
        title: 'Level 2\u2014Basic',
        description: 'Salt industry employee at the basic level with developing skills, performing a range of production tasks including equipment operation and quality monitoring.',
        duties: ['Operating basic salt processing and handling equipment', 'Performing quality checks on salt products', 'Assisting with maintenance of production machinery', 'Following production schedules and recording output data'],
        indicative_tasks: [],
        sort_order: 70,
      },
      {
        ...
        description: 'Experienced salt industry employee at the intermediate level, performing skilled production tasks and operating complex equipment with limited supervision.',
        duties: ['Operating complex salt production and processing equipment', 'Performing detailed quality control testing and inspections', 'Training and guiding lower-level employees', 'Coordinating production workflows and team activities'],
        indicative_tasks: [],
        sort_order: 90,
      },
      {
        level: 4, stream: 'general',
        title: 'Level 4\u2014Competent',
        description: 'Senior salt industry employee at the competent level, performing advanced production, maintenance, or supervisory duties with significant autonomy.',
        duties: ['Performing trade-level maintenance on production equipment', 'Supervising production teams and allocating daily work', 'Troubleshooting production issues and equipment faults', 'Ensuring compliance with safety and quality standards'],
        indicative_tasks: [],
        sort_order: 110,
      },
      {
        ...
        description: 'Advanced salt industry employee performing the most skilled production, technical, or management duties with broad expertise and leadership responsibilities.',
        duties: ['Managing production schedules and resource allocation', 'Developing and implementing production procedures', 'Overseeing quality assurance programs and regulatory compliance', 'Leading continuous improvement initiatives across operations'],
        indicative_tasks: [],
        sort_order: 130,
      },
    ];
    ...
    const penaltyRates = [
      ...
      },
      {
        ...
        description: 'Public holiday - all day — Full-time ×2.5',
      },
      {
      ...
      },
      {
        ...
        time_band_start: null, time_band_end: null, time_band_label: null,
        multiplier: 2.5, addition_per_hour: null,
        description: 'Public holiday - all day — Part-time ×2.5',
      },
      {
      ...
      },
      {
        ...
        description: 'Shiftworkers: Sunday & public holiday — Casual ×2.25',
      },
    ];
    ...
    const allowances = [
      ...
      },
      {
        ...
        description: 'Motor vehicle allowance',
        trigger_condition: 'As per award conditions',
      ...
      },
      {
        ...
        description: 'Industry allowance',
        trigger_condition: 'As per award conditions',
        amount: 26.71, amount_type: 'weekly', per_unit: 'per_week',
      },
      {
        allowance_type: 'leading_hand',
        name: 'Leading hand allowance—11 to 20 employees',
        description: 'Leading hand allowance—11 to 20 employees',
        trigger_condition: 'As per award conditions',
        amount: 41.88, amount_type: 'weekly', per_unit: 'per_week',
      },
      {
        allowance_type: 'leading_hand',
        name: 'Leading hand allowance—3 to 10 employees',
        description: 'Leading hand allowance—3 to 10 employees',
        trigger_condition: 'As per award conditions',
        amount: 25.11, amount_type: 'weekly', per_unit: 'per_week',
      },
    ];
    ...
    const questions = [
      {
        ...
        sort_order: 1,
        answers: [
          { answer_key: 'junior_employees', answer_text: 'Junior Employees', sort_order: 1 },
          { answer_key: 'general', answer_text: 'General', sort_order: 2 },
        ],
      },
      {
        award_code: AWARD_CODE,
        question_key: 'a107_level',
        ...
        sort_order: 2,
        answers: [
          { answer_key: 'level_1', answer_text: 'At 17 years', sort_order: 1 },
          { answer_key: 'level_2', answer_text: 'Level 2—Basic', sort_order: 2 },
          { answer_key: 'level_3', answer_text: 'Level 3—Intermediate', sort_order: 3 },
          { answer_key: 'level_4', answer_text: 'Level 4—Competent', sort_order: 4 },
          { answer_key: 'level_5', answer_text: 'Level 5—Advanced', sort_order: 5 },
        ],
      },
    ];
