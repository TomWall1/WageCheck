/**
 * Seed script — Oil Refining and Manufacturing Award 2020 [MA000011]
 * Pay rates effective 1 July 2025
 * Source: FWC MAPD API + FWO pay guide MA000040
 *
 * One stream:
 *   oil_refining — Levels 1–5 (5 classifications)
 *
 * Adult FT/PT hourly rates:
 *   L1: $26.12   L2: $27.04   L3: $28.26   L4: $29.62   L5: $31.18
 *
...
async function seed() {
  ...
  try {
    ...
    `, [
      ...
      EFFECTIVE_DATE,
      'https://awards.fairwork.gov.au/MA000011.html',
    ]);

    // ── Classifications ────────────────────────────────────────────────────────
    const classifications = [
      { level: 1, stream: 'oil_refining', fwc_id: null, title: 'Oil Refining Level 1', description: 'Entry-level process worker under direct supervision.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Oil Refining Level 1'], sort_order: 10 },
      { level: 2, stream: 'oil_refining', fwc_id: null, title: 'Oil Refining Level 2', description: 'Experienced process worker operating basic equipment.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Oil Refining Level 2'], sort_order: 20 },
      { level: 3, stream: 'oil_refining', fwc_id: null, title: 'Oil Refining Level 3', description: 'Skilled operator controlling process units independently.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Oil Refining Level 3'], sort_order: 30 },
      { level: 4, stream: 'oil_refining', fwc_id: null, title: 'Oil Refining Level 4', description: 'Advanced operator or tradesperson with qualifications.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Oil Refining Level 4'], sort_order: 40 },
      { level: 5, stream: 'oil_refining', fwc_id: null, title: 'Oil Refining Level 5', description: 'Senior operator or leading hand supervising a team.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Oil Refining Level 5'], sort_order: 50 },
    ];
    ...
    //   Q1: oil_refining_level — level 1 through 5
    const questions = [
      {
        question_key: 'oil_refining_level',
        question_text: 'What is your oil refining classification level?',
        help_text: 'Your level depends on your experience and duties. Level 1 is entry-level process work. Higher levels involve controlling process units and supervising.',
    ...
    const answers = [
      { question_key: 'oil_refining_level', answer_key: 'l1', answer_text: 'Level 1 — Entry-level (process worker, refinery hand)', sort_order: 1 },
      { question_key: 'oil_refining_level', answer_key: 'l2', answer_text: 'Level 2 — Experienced (process operator, sample collector)', sort_order: 2 },
      { question_key: 'oil_refining_level', answer_key: 'l3', answer_text: 'Level 3 — Skilled (console operator, process controller)', sort_order: 3 },
      { question_key: 'oil_refining_level', answer_key: 'l4', answer_text: 'Level 4 — Tradesperson (fitter, instrument tech)', sort_order: 4 },
      { question_key: 'oil_refining_level', answer_key: 'l5', answer_text: 'Level 5 — Supervisor (shift supervisor, leading hand)', sort_order: 5 },
    ];
