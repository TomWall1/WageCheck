/**
 * Seed script — Airport Employees Award 2020 [MA000062]
 * Pay rates effective 1 July 2025
 * Source: FWC MAPD API + FWO pay guide MA000040
 *
 * One stream:
 *   airport — Levels 1–5 (5 classifications)
 *
...
async function seed() {
  ...
  try {
    ...
    `, [
      ...
      EFFECTIVE_DATE,
      'https://awards.fairwork.gov.au/MA000062.html',
    ]);

    // ── Classifications ────────────────────────────────────────────────────────
    const classifications = [
      { level: 1, stream: 'airport', fwc_id: null, title: 'Airport Employee Level 1', description: 'Entry-level airport employee performing basic terminal or airside duties.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Airport Employee Level 1'], sort_order: 10 },
      { level: 2, stream: 'airport', fwc_id: null, title: 'Airport Employee Level 2', description: 'Experienced worker with specific airside or terminal responsibilities.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Airport Employee Level 2'], sort_order: 20 },
      { level: 3, stream: 'airport', fwc_id: null, title: 'Airport Employee Level 3', description: 'Skilled worker operating specialist airport equipment or systems.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Airport Employee Level 3'], sort_order: 30 },
      { level: 4, stream: 'airport', fwc_id: null, title: 'Airport Employee Level 4', description: 'Senior worker or tradesperson with advanced airport duties.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Airport Employee Level 4'], sort_order: 40 },
      { level: 5, stream: 'airport', fwc_id: null, title: 'Airport Employee Level 5', description: 'Supervisor managing airport operations or maintenance teams.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Airport Employee Level 5'], sort_order: 50 },
    ];
    ...
    //   Q1: airport_level — level 1 through 5
    const questions = [
      {
        question_key: 'airport_level',
        question_text: 'What is your airport employee classification level?',
        help_text: 'Your level depends on your role and experience. Level 1 is entry-level airport work. Higher levels involve technical and supervisory roles.',
    ...
    const answers = [
      { question_key: 'airport_level', answer_key: 'l1', answer_text: 'Level 1 — Entry-level (terminal assistant, cleaner)', sort_order: 1 },
      { question_key: 'airport_level', answer_key: 'l2', answer_text: 'Level 2 — Experienced (airside officer, security screener)', sort_order: 2 },
      { question_key: 'airport_level', answer_key: 'l3', answer_text: 'Level 3 — Skilled (equipment operator, systems technician)', sort_order: 3 },
      { question_key: 'airport_level', answer_key: 'l4', answer_text: 'Level 4 — Senior (tradesperson, advanced operator)', sort_order: 4 },
      { question_key: 'airport_level', answer_key: 'l5', answer_text: 'Level 5 — Supervisor (operations supervisor, maintenance manager)', sort_order: 5 },
    ];
