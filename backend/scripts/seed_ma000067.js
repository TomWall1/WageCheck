/**
 * Seed script — Hydrocarbons Industry (Upstream) Award 2020 [MA000067]
 * Pay rates effective 1 July 2025
 * Source: FWC MAPD API + FWO pay guide MA000040
 *
 * One stream:
 *   hydrocarbons — Levels 1–6 (6 classifications)
 *
...
async function seed() {
  ...
  try {
    ...
    `, [
      ...
      EFFECTIVE_DATE,
      'https://awards.fairwork.gov.au/MA000067.html',
    ]);

    // ── Classifications ────────────────────────────────────────────────────────
    const classifications = [
      { level: 1, stream: 'hydrocarbons', fwc_id: null, title: 'Hydrocarbons Level 1', description: 'Entry-level process or field worker under direct supervision.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Hydrocarbons Level 1'], sort_order: 10 },
      { level: 2, stream: 'hydrocarbons', fwc_id: null, title: 'Hydrocarbons Level 2', description: 'Experienced worker operating basic production equipment.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Hydrocarbons Level 2'], sort_order: 20 },
      { level: 3, stream: 'hydrocarbons', fwc_id: null, title: 'Hydrocarbons Level 3', description: 'Skilled operator managing upstream production processes.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Hydrocarbons Level 3'], sort_order: 30 },
      { level: 4, stream: 'hydrocarbons', fwc_id: null, title: 'Hydrocarbons Level 4', description: 'Tradesperson performing maintenance on production facilities.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Hydrocarbons Level 4'], sort_order: 40 },
      { level: 5, stream: 'hydrocarbons', fwc_id: null, title: 'Hydrocarbons Level 5', description: 'Senior operator or team leader with advanced responsibilities.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Hydrocarbons Level 5'], sort_order: 50 },
      { level: 6, stream: 'hydrocarbons', fwc_id: null, title: 'Hydrocarbons Level 6', description: 'Supervisor managing production operations or maintenance programs.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Hydrocarbons Level 6'], sort_order: 60 },
    ];
    ...
    //   Q1: hydrocarbons_level — level 1 through 5
    const questions = [
      {
        question_key: 'hydrocarbons_level',
        question_text: 'What is your hydrocarbons industry classification level?',
        help_text: 'Your level depends on your experience and qualifications. Level 1 is entry-level process work. Higher levels involve skilled operations, trade qualifications, and supervision.',
    ...
    const answers = [
      { question_key: 'hydrocarbons_level', answer_key: 'l1', answer_text: 'Level 1 — Entry-level (field hand, roustabout)', sort_order: 1 },
      { question_key: 'hydrocarbons_level', answer_key: 'l2', answer_text: 'Level 2 — Experienced (production operator, derrickhand)', sort_order: 2 },
      { question_key: 'hydrocarbons_level', answer_key: 'l3', answer_text: 'Level 3 — Skilled (plant operator, driller)', sort_order: 3 },
      { question_key: 'hydrocarbons_level', answer_key: 'l4', answer_text: 'Level 4 — Tradesperson (fitter, electrician, instrument tech)', sort_order: 4 },
      { question_key: 'hydrocarbons_level', answer_key: 'l5', answer_text: 'Level 5 — Senior (team leader, tool pusher)', sort_order: 5 },
      { question_key: 'hydrocarbons_level', answer_key: 'l6', answer_text: 'Level 6 — Supervisor (production supervisor, rig manager)', sort_order: 6 },
    ];
