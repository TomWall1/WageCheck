/**
 * Seed script — Electrical Power Industry Award 2020 [MA000054]
 * Pay rates effective 1 July 2025
 * Source: FWC MAPD API + FWO pay guide MA000040
 *
 * One stream:
 *   electrical_power — Levels 1–6 (6 classifications)
 *
...
async function seed() {
  ...
  try {
    ...
    `, [
      ...
      EFFECTIVE_DATE,
      'https://awards.fairwork.gov.au/MA000054.html',
    ]);

    // ── Classifications ────────────────────────────────────────────────────────
    const classifications = [
      { level: 1, stream: 'electrical_power', fwc_id: null, title: 'Power Worker Level 1', description: 'Entry-level power industry worker under direct supervision.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Power Worker Level 1'], sort_order: 10 },
      { level: 2, stream: 'electrical_power', fwc_id: null, title: 'Power Worker Level 2', description: 'Experienced worker performing routine operational tasks.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Power Worker Level 2'], sort_order: 20 },
      { level: 3, stream: 'electrical_power', fwc_id: null, title: 'Power Worker Level 3', description: 'Skilled operator managing power generation or distribution equipment.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Power Worker Level 3'], sort_order: 30 },
      { level: 4, stream: 'electrical_power', fwc_id: null, title: 'Power Worker Level 4', description: 'Tradesperson performing maintenance on power infrastructure.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Power Worker Level 4'], sort_order: 40 },
      { level: 5, stream: 'electrical_power', fwc_id: null, title: 'Power Worker Level 5', description: 'Senior tradesperson or team leader with advanced responsibilities.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Power Worker Level 5'], sort_order: 50 },
      { level: 6, stream: 'electrical_power', fwc_id: null, title: 'Power Worker Level 6', description: 'Supervisor or specialist managing power station or network operations.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Power Worker Level 6'], sort_order: 60 },
    ];
    ...
    //   Q1: electrical_power_level — level 1 through 5
    const questions = [
      {
        question_key: 'electrical_power_level',
        question_text: 'What is your electrical power industry classification level?',
        help_text: 'Your level depends on your experience and qualifications. Level 1 is entry-level work. Higher levels involve trade qualifications and supervisory duties.',
    ...
    const answers = [
      { question_key: 'electrical_power_level', answer_key: 'l1', answer_text: 'Level 1 — Entry-level (plant hand, general worker)', sort_order: 1 },
      { question_key: 'electrical_power_level', answer_key: 'l2', answer_text: 'Level 2 — Experienced (operator assistant, lineworker trainee)', sort_order: 2 },
      { question_key: 'electrical_power_level', answer_key: 'l3', answer_text: 'Level 3 — Skilled (plant operator, lineworker)', sort_order: 3 },
      { question_key: 'electrical_power_level', answer_key: 'l4', answer_text: 'Level 4 — Tradesperson (electrician, fitter)', sort_order: 4 },
      { question_key: 'electrical_power_level', answer_key: 'l5', answer_text: 'Level 5 — Senior (team leader, advanced tradesperson)', sort_order: 5 },
      { question_key: 'electrical_power_level', answer_key: 'l6', answer_text: 'Level 6 — Supervisor (shift supervisor, network controller)', sort_order: 6 },
    ];
