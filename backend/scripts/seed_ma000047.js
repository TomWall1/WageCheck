/**
 * Seed script — Asphalt Industry Award 2020 [MA000047]
 * Pay rates effective 1 July 2025
 * Source: FWC MAPD API + FWO pay guide MA000040
 *
 * One stream:
 *   asphalt — Levels 1–5 (5 classifications)
 *
...
async function seed() {
  ...
  try {
    ...
    `, [
      ...
      EFFECTIVE_DATE,
      'https://awards.fairwork.gov.au/MA000047.html',
    ]);

    // ── Classifications ────────────────────────────────────────────────────────
    const classifications = [
      { level: 1, stream: 'asphalt', fwc_id: null, title: 'Asphalt Industry Level 1', description: 'Entry-level asphalt worker performing basic labouring tasks.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Asphalt Industry Level 1'], sort_order: 10 },
      { level: 2, stream: 'asphalt', fwc_id: null, title: 'Asphalt Industry Level 2', description: 'Experienced worker operating raking and rolling equipment.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Asphalt Industry Level 2'], sort_order: 20 },
      { level: 3, stream: 'asphalt', fwc_id: null, title: 'Asphalt Industry Level 3', description: 'Skilled plant operator managing asphalt production independently.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Asphalt Industry Level 3'], sort_order: 30 },
      { level: 4, stream: 'asphalt', fwc_id: null, title: 'Asphalt Industry Level 4', description: 'Tradesperson or advanced plant operator with qualifications.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Asphalt Industry Level 4'], sort_order: 40 },
      { level: 5, stream: 'asphalt', fwc_id: null, title: 'Asphalt Industry Level 5', description: 'Leading hand or supervisor coordinating asphalt operations.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Asphalt Industry Level 5'], sort_order: 50 },
    ];
    ...
    //   Q1: asphalt_level — level 1 through 5
    const questions = [
      {
        question_key: 'asphalt_level',
        question_text: 'What is your asphalt industry classification level?',
        help_text: 'Your level depends on your experience and duties. Level 1 is entry-level labouring. Higher levels involve plant operation and supervision.',
    ...
    const answers = [
      { question_key: 'asphalt_level', answer_key: 'l1', answer_text: 'Level 1 — Entry-level (labourer, general hand)', sort_order: 1 },
      { question_key: 'asphalt_level', answer_key: 'l2', answer_text: 'Level 2 — Experienced (raker, roller operator)', sort_order: 2 },
      { question_key: 'asphalt_level', answer_key: 'l3', answer_text: 'Level 3 — Skilled (plant operator, paver operator)', sort_order: 3 },
      { question_key: 'asphalt_level', answer_key: 'l4', answer_text: 'Level 4 — Tradesperson (fitter, advanced operator)', sort_order: 4 },
      { question_key: 'asphalt_level', answer_key: 'l5', answer_text: 'Level 5 — Supervisor (leading hand, foreman)', sort_order: 5 },
    ];
