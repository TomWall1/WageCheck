    ...
    const classifications = [
      {
        ...
        description: 'Entry-level seafood processing employee performing basic preparation, cleaning, and packing duties under direct supervision.',
        duties: ['Cleaning and preparing seafood for processing', 'Packing finished seafood products into containers', 'Maintaining hygiene and cleanliness of processing areas', 'Assisting with loading and unloading raw materials'],
        indicative_tasks: [],
        sort_order: 10,
      },
      {
        ...
        description: 'Seafood processing employee with developing skills performing a range of processing tasks including grading, filleting, and machine operation.',
        duties: ['Grading and sorting seafood by species, size, and quality', 'Operating basic processing machinery and equipment', 'Performing filleting, shucking, or peeling tasks', 'Monitoring product quality during processing'],
        indicative_tasks: [],
        sort_order: 20,
      },
      {
        ...
        description: 'Experienced seafood processing employee performing skilled tasks including quality control, equipment operation, and team coordination.',
        duties: ['Operating complex seafood processing equipment', 'Performing quality control inspections and testing', 'Coordinating workflow and guiding junior process attendants', 'Maintaining processing records and batch documentation'],
        indicative_tasks: [],
        sort_order: 30,
      },
      {
        ...
        description: 'Senior seafood processing employee or team leader performing advanced production, quality assurance, and supervisory duties.',
        duties: ['Supervising processing teams and allocating tasks', 'Managing quality assurance procedures and HACCP compliance', 'Troubleshooting processing equipment and production issues', 'Training staff on processing techniques and safety procedures'],
        indicative_tasks: [],
        sort_order: 40,
      },
    ];
