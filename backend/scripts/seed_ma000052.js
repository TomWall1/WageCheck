    ...
    const classifications = [
      {
        ...
        description: 'Crane Driver (under 20 tonnes)',
        duties: [],
        indicative_tasks: [],
        sort_order: 10,
      },
      ...
      },
      {
        ...
        description: 'Crane Driver (over 20 tonnes)',
        duties: [],
        indicative_tasks: [],
        sort_order: 30,
      },
      {
        ...
        description: 'General Purpose Hand, Deckhand, Greaser, Passenger Attendant, Turnstile Attendant, Boating Attendant, Host, Fireman, Trimmer, Linesman, Cook, Sailor, Able Seaman, Leading Hand',
        duties: [],
        indicative_tasks: [],
        sort_order: 40,
      },
