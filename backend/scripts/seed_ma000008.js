/**
 * Seed script — Wool Storage, Sampling and Testing Award 2020 [MA000008]
 * Pay rates effective 1 July 2025
 * Source: FWC MAPD API + FWO pay guide MA000040
 *
 * One stream:
 *   wool — Levels 1–4 (4 classifications)
 *
 * Adult FT/PT hourly rates:
 *   L1: $25.44   L2: $26.12   L3: $27.04   L4: $28.26
 *
...
async function seed() {
  ...
  try {
    ...
    `, [
      ...
      EFFECTIVE_DATE,
      'https://awards.fairwork.gov.au/MA000008.html',
    ]);

    // ── Classifications ────────────────────────────────────────────────────────
    const classifications = [
      { level: 1, stream: 'wool', fwc_id: null, title: 'Wool Storage Level 1', description: 'Entry-level wool handler. Basic storage and handling tasks under supervision.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Wool Storage Level 1'], sort_order: 10 },
      { level: 2, stream: 'wool', fwc_id: null, title: 'Wool Storage Level 2', description: 'Experienced handler with sampling duties and limited supervision.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Wool Storage Level 2'], sort_order: 20 },
      { level: 3, stream: 'wool', fwc_id: null, title: 'Wool Storage Level 3', description: 'Skilled sampler or tester performing quality control independently.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Wool Storage Level 3'], sort_order: 30 },
      { level: 4, stream: 'wool', fwc_id: null, title: 'Wool Storage Level 4', description: 'Senior tester or supervisor overseeing testing operations.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Wool Storage Level 4'], sort_order: 40 },
    ];
    ...
    //   Q1: wool_level — level 1 through 5
    const questions = [
      {
        question_key: 'wool_level',
        question_text: 'What is your wool storage classification level?',
        help_text: 'Your level depends on your experience and duties. Level 1 is entry-level wool handling. Higher levels involve sampling, testing, and supervising.',
    ...
    const answers = [
      { question_key: 'wool_level', answer_key: 'l1', answer_text: 'Level 1 — Entry-level (wool handler, storeworker)', sort_order: 1 },
      { question_key: 'wool_level', answer_key: 'l2', answer_text: 'Level 2 — Experienced (wool sampler, forklift operator)', sort_order: 2 },
      { question_key: 'wool_level', answer_key: 'l3', answer_text: 'Level 3 — Skilled (wool tester, quality controller)', sort_order: 3 },
      { question_key: 'wool_level', answer_key: 'l4', answer_text: 'Level 4 — Supervisor (senior tester, lab supervisor)', sort_order: 4 },
    ];
