/**
 * Seed script — Professional Diving Industry (Recreational) Award 2020 [MA000109]
 * Pay rates effective 1 July 2025 (following 2025 Annual Wage Review)
 * Rates sourced from FWC MAPD API.
 *
 * Run after migrate.js: node scripts/seed_ma000109.js
 */
require('dotenv').config();
const pool = require('../src/db/pool');

const AWARD_CODE = 'MA000109';
...
async function seed() {
  ...
  try {
    ...
    `, [
      ...
      EFFECTIVE_DATE,
      'https://www.fairwork.gov.au/employment-conditions/awards/awards-summary/ma000109-summary',
    ]);
    ...
    const classifications = [
      {
        ...
        title: 'Dive master',
        description: 'Qualified divemaster supervising recreational dive activities, leading guided dives, and assisting dive instructors with training operations.',
        duties: ['Leading and supervising guided recreational dives', 'Conducting dive site briefings and safety assessments', 'Assisting dive instructors with student training', 'Monitoring diver safety and managing dive groups', 'Maintaining dive equipment and conducting pre-dive checks'],
        indicative_tasks: [],
        sort_order: 10,
      },
      {
        ...
        description: 'Qualified recreational dive instructor teaching scuba diving courses, certifying students, and managing dive operations.',
        duties: ['Teaching and certifying recreational scuba diving students', 'Conducting pool and open water training sessions', 'Assessing student competency and awarding certifications', 'Managing dive operations and safety procedures', 'Maintaining training records and certification documentation'],
        indicative_tasks: [],
        sort_order: 20,
      },
    ];
    ...
    const allowances = [
      {
        allowance_type: 'language_allowance',
        name: 'Language allowance',
        description: 'Language allowance',
        trigger_condition: 'As per award conditions',
        amount: 59.9, amount_type: 'weekly', per_unit: 'per_week',
      },
    ];
    ...
    const questions = [
      {
        ...
        sort_order: 1,
        answers: [
          { answer_key: 'level_1', answer_text: 'Dive master', sort_order: 1 },
          { answer_key: 'level_2', answer_text: 'Dive instructor', sort_order: 2 },
        ],
      },
    ];
