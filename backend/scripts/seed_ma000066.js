/**
 * Seed script — Horse and Greyhound Training Award 2020 [MA000066]
 * Pay rates effective 1 July 2025
 * Source: FWC MAPD API + FWO pay guide MA000040
 *
 * One stream:
 *   animal_training — Levels 1–5 (5 classifications)
 *
...
async function seed() {
  ...
  try {
    ...
    `, [
      ...
      EFFECTIVE_DATE,
      'https://awards.fairwork.gov.au/MA000066.html',
    ]);

    // ── Classifications ────────────────────────────────────────────────────────
    const classifications = [
      { level: 1, stream: 'animal_training', fwc_id: null, title: 'Stablehand/Kennel Attendant Level 1', description: 'Entry-level stablehand or kennel attendant under supervision.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Stablehand/Kennel Attendant Level 1'], sort_order: 10 },
      { level: 2, stream: 'animal_training', fwc_id: null, title: 'Stablehand/Kennel Attendant Level 2', description: 'Experienced stablehand or kennel attendant with broader responsibilities.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Stablehand/Kennel Attendant Level 2'], sort_order: 20 },
      { level: 3, stream: 'animal_training', fwc_id: null, title: 'Trackwork Rider/Senior Attendant Level 3', description: 'Trackwork rider or senior attendant performing skilled animal handling.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Trackwork Rider/Senior Attendant Level 3'], sort_order: 30 },
      { level: 4, stream: 'animal_training', fwc_id: null, title: 'Senior Trackwork Rider Level 4', description: 'Senior trackwork rider or experienced trainer assistant.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Senior Trackwork Rider Level 4'], sort_order: 40 },
      { level: 5, stream: 'animal_training', fwc_id: null, title: 'Head Stablehand/Foreperson Level 5', description: 'Head stablehand or foreperson supervising stable or kennel operations.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Head Stablehand/Foreperson Level 5'], sort_order: 50 },
    ];
    ...
    //   Q1: animal_training_level — level 1 through 5
    const questions = [
      {
        question_key: 'animal_training_level',
        question_text: 'What is your horse or greyhound training classification level?',
        help_text: 'Your level depends on your experience and role. Level 1 is entry-level stablehand work. Higher levels involve trackwork riding and senior training duties.',
    ...
    const answers = [
      { question_key: 'animal_training_level', answer_key: 'l1', answer_text: 'Level 1 — Entry-level (stablehand, kennel attendant)', sort_order: 1 },
      { question_key: 'animal_training_level', answer_key: 'l2', answer_text: 'Level 2 — Experienced (senior stablehand, kennel hand)', sort_order: 2 },
      { question_key: 'animal_training_level', answer_key: 'l3', answer_text: 'Level 3 — Skilled (trackwork rider, senior attendant)', sort_order: 3 },
      { question_key: 'animal_training_level', answer_key: 'l4', answer_text: 'Level 4 — Senior (senior trackwork rider, trainer assistant)', sort_order: 4 },
      { question_key: 'animal_training_level', answer_key: 'l5', answer_text: 'Level 5 — Foreperson (head stablehand, kennel manager)', sort_order: 5 },
    ];
