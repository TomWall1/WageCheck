/**
 * Seed script — Coal Export Terminals Award 2020 [MA000051]
 * Pay rates effective 1 July 2025
 * Source: FWC MAPD API + FWO pay guide MA000040
 *
 * One stream:
 *   coal_terminal — Levels 1–5 (5 classifications)
 *
...
async function seed() {
  ...
  try {
    ...
    `, [
      ...
      EFFECTIVE_DATE,
      'https://awards.fairwork.gov.au/MA000051.html',
    ]);

    // ── Classifications ────────────────────────────────────────────────────────
    const classifications = [
      { level: 1, stream: 'coal_terminal', fwc_id: null, title: 'Terminal Employee Level 1', description: 'Entry-level terminal worker performing basic loading and stockpile tasks.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Terminal Employee Level 1'], sort_order: 10 },
      { level: 2, stream: 'coal_terminal', fwc_id: null, title: 'Terminal Employee Level 2', description: 'Experienced worker operating conveyor systems and basic equipment.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Terminal Employee Level 2'], sort_order: 20 },
      { level: 3, stream: 'coal_terminal', fwc_id: null, title: 'Terminal Employee Level 3', description: 'Skilled operator managing shiploading and stacking equipment.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Terminal Employee Level 3'], sort_order: 30 },
      { level: 4, stream: 'coal_terminal', fwc_id: null, title: 'Terminal Employee Level 4', description: 'Tradesperson or advanced operator with qualifications.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Terminal Employee Level 4'], sort_order: 40 },
      { level: 5, stream: 'coal_terminal', fwc_id: null, title: 'Terminal Employee Level 5', description: 'Supervisor coordinating terminal loading operations.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Terminal Employee Level 5'], sort_order: 50 },
    ];
    ...
    //   Q1: coal_terminal_level — level 1 through 5
    const questions = [
      {
        question_key: 'coal_terminal_level',
        question_text: 'What is your coal export terminal classification level?',
        help_text: 'Your level depends on your experience and duties. Level 1 is entry-level terminal work. Higher levels involve operating heavy equipment and supervision.',
    ...
    const answers = [
      { question_key: 'coal_terminal_level', answer_key: 'l1', answer_text: 'Level 1 — Entry-level (terminal hand, yard worker)', sort_order: 1 },
      { question_key: 'coal_terminal_level', answer_key: 'l2', answer_text: 'Level 2 — Experienced (conveyor operator)', sort_order: 2 },
      { question_key: 'coal_terminal_level', answer_key: 'l3', answer_text: 'Level 3 — Skilled (shiploader operator, stacker operator)', sort_order: 3 },
      { question_key: 'coal_terminal_level', answer_key: 'l4', answer_text: 'Level 4 — Tradesperson (maintenance fitter, electrician)', sort_order: 4 },
      { question_key: 'coal_terminal_level', answer_key: 'l5', answer_text: 'Level 5 — Supervisor (shift coordinator, operations supervisor)', sort_order: 5 },
    ];
