/**
 * Seed script — Corrections and Detention (Private Sector) Award 2020 [MA000017]
 * Pay rates effective 1 July 2025
 * Source: FWC MAPD API + FWO pay guide MA000040
 *
 * One stream:
 *   corrections — Levels 1–5 (5 classifications)
 *
...
async function seed() {
  ...
  try {
    ...
    `, [
      ...
      EFFECTIVE_DATE,
      'https://awards.fairwork.gov.au/MA000017.html',
    ]);

    // ── Classifications ────────────────────────────────────────────────────────
    const classifications = [
      { level: 1, stream: 'corrections', fwc_id: null, title: 'Correctional Officer Level 1', description: 'Entry-level correctional or detention officer under direct supervision.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Correctional Officer Level 1'], sort_order: 10 },
      { level: 2, stream: 'corrections', fwc_id: null, title: 'Correctional Officer Level 2', description: 'Experienced officer performing custodial duties independently.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Correctional Officer Level 2'], sort_order: 20 },
      { level: 3, stream: 'corrections', fwc_id: null, title: 'Correctional Officer Level 3', description: 'Skilled officer with specialist duties or unit management responsibilities.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Correctional Officer Level 3'], sort_order: 30 },
      { level: 4, stream: 'corrections', fwc_id: null, title: 'Senior Correctional Officer Level 4', description: 'Senior officer supervising teams and managing operational areas.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Senior Correctional Officer Level 4'], sort_order: 40 },
      { level: 5, stream: 'corrections', fwc_id: null, title: 'Correctional Supervisor Level 5', description: 'Supervisor or manager overseeing correctional facility operations.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Correctional Supervisor Level 5'], sort_order: 50 },
    ];
    ...
    //   Q1: corrections_level — level 1 through 5
    const questions = [
      {
        question_key: 'corrections_level',
        question_text: 'What is your corrections and detention classification level?',
        help_text: 'Your level depends on your role, experience, and qualifications. Level 1 is entry-level custodial work. Higher levels involve supervisory and management duties.',
    ...
    const answers = [
      { question_key: 'corrections_level', answer_key: 'l1', answer_text: 'Level 1 — Entry-level (trainee correctional officer)', sort_order: 1 },
      { question_key: 'corrections_level', answer_key: 'l2', answer_text: 'Level 2 — Experienced (correctional officer)', sort_order: 2 },
      { question_key: 'corrections_level', answer_key: 'l3', answer_text: 'Level 3 — Skilled (specialist officer, unit manager)', sort_order: 3 },
      { question_key: 'corrections_level', answer_key: 'l4', answer_text: 'Level 4 — Senior (team supervisor)', sort_order: 4 },
      { question_key: 'corrections_level', answer_key: 'l5', answer_text: 'Level 5 — Supervisor (facility operations manager)', sort_order: 5 },
    ];
