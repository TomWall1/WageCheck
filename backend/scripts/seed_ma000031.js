/**
 * Seed script — Mannequins and Models Award 2020 [MA000031]
 * Pay rates effective 1 July 2025
 * Source: FWC MAPD API + FWO pay guide MA000040
 *
 * One stream:
 *   modelling — Levels 1–3 (3 classifications)
 *
...
async function seed() {
  ...
  try {
    ...
    `, [
      ...
      EFFECTIVE_DATE,
      'https://awards.fairwork.gov.au/MA000031.html',
    ]);

    // ── Classifications ────────────────────────────────────────────────────────
    const classifications = [
      { level: 1, stream: 'modelling', fwc_id: null, title: 'Model Grade 1', description: 'Fitting model or promotional model performing basic modelling tasks.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Model Grade 1'], sort_order: 10 },
      { level: 2, stream: 'modelling', fwc_id: null, title: 'Model Grade 2', description: 'Experienced photographic or runway model.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Model Grade 2'], sort_order: 20 },
      { level: 3, stream: 'modelling', fwc_id: null, title: 'Model Grade 3', description: 'Senior model with extensive experience in high-end fashion or editorial work.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Model Grade 3'], sort_order: 30 },
    ];
    ...
    //   Q1: model_grade — level 1 through 5
    const questions = [
      {
        question_key: 'model_grade',
        question_text: 'What type of modelling work do you do?',
        help_text: 'Your classification depends on the type of modelling work — photographic, runway, promotional, or fitting work.',
    ...
    const answers = [
      { question_key: 'model_grade', answer_key: 'l1', answer_text: 'Grade 1 — Fitting model or promotional model', sort_order: 1 },
      { question_key: 'model_grade', answer_key: 'l2', answer_text: 'Grade 2 — Photographic or runway model', sort_order: 2 },
      { question_key: 'model_grade', answer_key: 'l3', answer_text: 'Grade 3 — Senior/editorial model', sort_order: 3 },
    ];
