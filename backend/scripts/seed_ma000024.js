/**
 * Seed script — Cotton Ginning Award 2020 [MA000024]
 * Pay rates effective 1 July 2025
 * Source: FWC MAPD API + FWO pay guide MA000040
 *
 * One stream:
 *   cotton_ginning — Levels 1–5 (5 classifications)
 *
...
async function seed() {
  ...
  try {
    ...
    `, [
      ...
      EFFECTIVE_DATE,
      'https://awards.fairwork.gov.au/MA000024.html',
    ]);

    // ── Classifications ────────────────────────────────────────────────────────
    const classifications = [
      { level: 1, stream: 'cotton_ginning', fwc_id: null, title: 'Cotton Ginning Level 1', description: 'Entry-level gin worker. Basic tasks under direct supervision.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Cotton Ginning Level 1'], sort_order: 10 },
      { level: 2, stream: 'cotton_ginning', fwc_id: null, title: 'Cotton Ginning Level 2', description: 'Experienced gin worker operating basic machinery.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Cotton Ginning Level 2'], sort_order: 20 },
      { level: 3, stream: 'cotton_ginning', fwc_id: null, title: 'Cotton Ginning Level 3', description: 'Skilled gin operator working independently.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Cotton Ginning Level 3'], sort_order: 30 },
      { level: 4, stream: 'cotton_ginning', fwc_id: null, title: 'Cotton Ginning Level 4', description: 'Senior operator or tradesperson with qualifications.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Cotton Ginning Level 4'], sort_order: 40 },
      { level: 5, stream: 'cotton_ginning', fwc_id: null, title: 'Cotton Ginning Level 5', description: 'Leading hand or supervisor coordinating operations.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Cotton Ginning Level 5'], sort_order: 50 },
    ];
    ...
    //   Q1: cotton_ginning_level — level 1 through 5
    const questions = [
      {
        question_key: 'cotton_ginning_level',
        question_text: 'What is your cotton ginning classification level?',
        help_text: 'Your level depends on your experience and duties. Level 1 is entry-level gin work. Higher levels involve operating machinery and supervising.',
    ...
    const answers = [
      { question_key: 'cotton_ginning_level', answer_key: 'l1', answer_text: 'Level 1 — Entry-level (gin labourer, general hand)', sort_order: 1 },
      { question_key: 'cotton_ginning_level', answer_key: 'l2', answer_text: 'Level 2 — Experienced (module feeder, gin operator)', sort_order: 2 },
      { question_key: 'cotton_ginning_level', answer_key: 'l3', answer_text: 'Level 3 — Skilled (press operator, gin stand operator)', sort_order: 3 },
      { question_key: 'cotton_ginning_level', answer_key: 'l4', answer_text: 'Level 4 — Tradesperson (gin tradesperson, senior operator)', sort_order: 4 },
      { question_key: 'cotton_ginning_level', answer_key: 'l5', answer_text: 'Level 5 — Supervisor (leading hand, gin supervisor)', sort_order: 5 },
    ];
