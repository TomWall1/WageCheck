/**
 * Seed script — Salt Industry Award 2020 [MA000037]
 * Pay rates effective 1 July 2025
 * Source: FWC MAPD API + FWO pay guide MA000040
 *
 * One stream:
 *   salt — Levels 1–5 (5 classifications)
 *
...
async function seed() {
  ...
  try {
    ...
    `, [
      ...
      EFFECTIVE_DATE,
      'https://awards.fairwork.gov.au/MA000037.html',
    ]);

    // ── Classifications ────────────────────────────────────────────────────────
    const classifications = [
      { level: 1, stream: 'salt', fwc_id: null, title: 'Salt Industry Level 1', description: 'Entry-level salt worker performing basic harvesting and processing tasks.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Salt Industry Level 1'], sort_order: 10 },
      { level: 2, stream: 'salt', fwc_id: null, title: 'Salt Industry Level 2', description: 'Experienced worker operating basic equipment with limited supervision.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Salt Industry Level 2'], sort_order: 20 },
      { level: 3, stream: 'salt', fwc_id: null, title: 'Salt Industry Level 3', description: 'Skilled operator managing processing equipment independently.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Salt Industry Level 3'], sort_order: 30 },
      { level: 4, stream: 'salt', fwc_id: null, title: 'Salt Industry Level 4', description: 'Tradesperson or advanced operator with qualifications.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Salt Industry Level 4'], sort_order: 40 },
      { level: 5, stream: 'salt', fwc_id: null, title: 'Salt Industry Level 5', description: 'Leading hand or supervisor coordinating operations.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Salt Industry Level 5'], sort_order: 50 },
    ];
    ...
    //   Q1: salt_level — level 1 through 5
    const questions = [
      {
        question_key: 'salt_level',
        question_text: 'What is your salt industry classification level?',
        help_text: 'Your level depends on your experience and duties. Level 1 is entry-level harvesting work. Higher levels involve operating machinery and supervising.',
    ...
    const answers = [
      { question_key: 'salt_level', answer_key: 'l1', answer_text: 'Level 1 — Entry-level (salt harvester, general hand)', sort_order: 1 },
      { question_key: 'salt_level', answer_key: 'l2', answer_text: 'Level 2 — Experienced (equipment operator)', sort_order: 2 },
      { question_key: 'salt_level', answer_key: 'l3', answer_text: 'Level 3 — Skilled (processing plant operator)', sort_order: 3 },
      { question_key: 'salt_level', answer_key: 'l4', answer_text: 'Level 4 — Tradesperson (maintenance fitter)', sort_order: 4 },
      { question_key: 'salt_level', answer_key: 'l5', answer_text: 'Level 5 — Supervisor (leading hand, shift supervisor)', sort_order: 5 },
    ];
