/**
 * Seed script — Rail Industry Award 2020 [MA000075]
 * Pay rates effective 1 July 2025
 * Source: FWC MAPD API + FWO pay guide MA000040
 *
 * One stream:
 *   rail — Levels 1–7 (7 classifications)
 *
...
async function seed() {
  ...
  try {
    ...
    `, [
      ...
      EFFECTIVE_DATE,
      'https://awards.fairwork.gov.au/MA000075.html',
    ]);

    // ── Classifications ────────────────────────────────────────────────────────
    const classifications = [
      { level: 1, stream: 'rail', fwc_id: null, title: 'Rail Worker Level 1', description: 'Entry-level rail worker performing basic track and yard duties.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Rail Worker Level 1'], sort_order: 10 },
      { level: 2, stream: 'rail', fwc_id: null, title: 'Rail Worker Level 2', description: 'Experienced worker performing routine rail operations.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Rail Worker Level 2'], sort_order: 20 },
      { level: 3, stream: 'rail', fwc_id: null, title: 'Rail Worker Level 3', description: 'Qualified operator or signaller with relevant certifications.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Rail Worker Level 3'], sort_order: 30 },
      { level: 4, stream: 'rail', fwc_id: null, title: 'Rail Worker Level 4', description: 'Train driver or skilled technical worker.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Rail Worker Level 4'], sort_order: 40 },
      { level: 5, stream: 'rail', fwc_id: null, title: 'Rail Worker Level 5', description: 'Senior driver or team leader with advanced responsibilities.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Rail Worker Level 5'], sort_order: 50 },
      { level: 6, stream: 'rail', fwc_id: null, title: 'Rail Worker Level 6', description: 'Tradesperson or specialist maintaining rolling stock and infrastructure.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Rail Worker Level 6'], sort_order: 60 },
      { level: 7, stream: 'rail', fwc_id: null, title: 'Rail Worker Level 7', description: 'Supervisor or manager overseeing rail operations or maintenance.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Rail Worker Level 7'], sort_order: 70 },
    ];
    ...
    //   Q1: rail_level — level 1 through 5
    const questions = [
      {
        question_key: 'rail_level',
        question_text: 'What is your rail industry classification level?',
        help_text: 'Your level depends on your role, experience, and qualifications. Level 1 is entry-level rail work. Higher levels involve driving, signalling, trade qualifications, and management.',
    ...
    const answers = [
      { question_key: 'rail_level', answer_key: 'l1', answer_text: 'Level 1 — Entry-level (track worker, yard hand)', sort_order: 1 },
      { question_key: 'rail_level', answer_key: 'l2', answer_text: 'Level 2 — Experienced (shunter, station assistant)', sort_order: 2 },
      { question_key: 'rail_level', answer_key: 'l3', answer_text: 'Level 3 — Qualified (signaller, train controller trainee)', sort_order: 3 },
      { question_key: 'rail_level', answer_key: 'l4', answer_text: 'Level 4 — Driver (train driver, skilled technician)', sort_order: 4 },
      { question_key: 'rail_level', answer_key: 'l5', answer_text: 'Level 5 — Senior (senior driver, team leader)', sort_order: 5 },
      { question_key: 'rail_level', answer_key: 'l6', answer_text: 'Level 6 — Tradesperson (rolling stock fitter, signal electrician)', sort_order: 6 },
      { question_key: 'rail_level', answer_key: 'l7', answer_text: 'Level 7 — Supervisor (operations manager, depot supervisor)', sort_order: 7 },
    ];
