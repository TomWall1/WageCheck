  ...
  try {
    ...
    const classifications = [
      ...
      },
      {
        ...
        description: 'Maintenance tradesperson undertaking accredited training—upon completion of 33% of the modules required',
        duties: [],
        indicative_tasks: [],
        sort_order: 50,
      },
      {
        ...
        description: 'Maintenance tradesperson undertaking accredited training—upon completion of 66% of the modules required',
        duties: [],
        indicative_tasks: [],
        sort_order: 60,
      },
    ...
    const questions = [
      {
        ...
        answers: [
          ...
          { answer_key: 'level_1', answer_text: 'Grade 4', sort_order: 2 },
          { answer_key: 'level_1', answer_text: 'Grade 4', sort_order: 3 },
          { answer_key: 'level_2', answer_text: 'Grade 2', sort_order: 4 },
          { answer_key: 'level_2', answer_text: 'Maintenance tradesperson undertaking accredited training—upon completion of 33% of the modules required', sort_order: 5 },
          { answer_key: 'level_2', answer_text: 'Maintenance tradesperson undertaking accredited training—upon completion of 66% of the modules required', sort_order: 6 },
          { answer_key: 'level_3', answer_text: 'Grade 3', sort_order: 7 },
          { answer_key: 'level_4', answer_text: 'Grade 4', sort_order: 8 },
          { answer_key: 'level_5', answer_text: 'Grade 5', sort_order: 9 },
          { answer_key: 'level_6', answer_text: 'Grade 6', sort_order: 10 },
          { answer_key: 'level_7', answer_text: 'Grade 7', sort_order: 11 },
        ],
      },
    ];
