/**
 * Seed script — Cemetery Industry Award 2020 [MA000048]
 * Pay rates effective 1 July 2025
 * Source: FWC MAPD API + FWO pay guide MA000040
 *
 * One stream:
 *   cemetery — Levels 1–5 (5 classifications)
 *
...
async function seed() {
  ...
  try {
    ...
    `, [
      ...
      EFFECTIVE_DATE,
      'https://awards.fairwork.gov.au/MA000048.html',
    ]);

    // ── Classifications ────────────────────────────────────────────────────────
    const classifications = [
      { level: 1, stream: 'cemetery', fwc_id: null, title: 'Cemetery Worker Level 1', description: 'Entry-level cemetery worker performing basic grounds maintenance.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Cemetery Worker Level 1'], sort_order: 10 },
      { level: 2, stream: 'cemetery', fwc_id: null, title: 'Cemetery Worker Level 2', description: 'Experienced worker performing interment preparation and grounds duties.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Cemetery Worker Level 2'], sort_order: 20 },
      { level: 3, stream: 'cemetery', fwc_id: null, title: 'Cemetery Worker Level 3', description: 'Skilled worker operating machinery and performing specialist tasks.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Cemetery Worker Level 3'], sort_order: 30 },
      { level: 4, stream: 'cemetery', fwc_id: null, title: 'Cemetery Worker Level 4', description: 'Senior worker or tradesperson with advanced duties.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Cemetery Worker Level 4'], sort_order: 40 },
      { level: 5, stream: 'cemetery', fwc_id: null, title: 'Cemetery Worker Level 5', description: 'Supervisor or manager coordinating cemetery operations.', duties: ['Performing duties at this classification level'], indicative_tasks: ['Cemetery Worker Level 5'], sort_order: 50 },
    ];
    ...
    //   Q1: cemetery_level — level 1 through 5
    const questions = [
      {
        question_key: 'cemetery_level',
        question_text: 'What is your cemetery industry classification level?',
        help_text: 'Your level depends on your experience and duties. Level 1 is entry-level grounds work. Higher levels involve specialist duties and supervision.',
    ...
    const answers = [
      { question_key: 'cemetery_level', answer_key: 'l1', answer_text: 'Level 1 — Entry-level (grounds worker)', sort_order: 1 },
      { question_key: 'cemetery_level', answer_key: 'l2', answer_text: 'Level 2 — Experienced (interment preparation, grounds maintenance)', sort_order: 2 },
      { question_key: 'cemetery_level', answer_key: 'l3', answer_text: 'Level 3 — Skilled (machinery operator, memorial mason)', sort_order: 3 },
      { question_key: 'cemetery_level', answer_key: 'l4', answer_text: 'Level 4 — Senior (tradesperson, crematorium operator)', sort_order: 4 },
      { question_key: 'cemetery_level', answer_key: 'l5', answer_text: 'Level 5 — Supervisor (operations coordinator)', sort_order: 5 },
    ];
